...
public class Corpse
{
   ...
   private float hitTime;          //used to show hit graphic when the NPC gets damaged
   private float size;             //size of the corpse to draw

   //ARGS:       picture,     charIndex   row,   col,   mapInd, gold,  weapon,   armor,   items,         removeal-day size
   public Corpse(ImageIcon p, byte ci, int r, int c, int mi, int g, Weapon w, Armor a, ArrayList<Item> i, int rd, float z)
   {
      picture = p;
      charIndex = ci;
      row = r;
