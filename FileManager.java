...
//     If the file doesn't exist or is improperly formated, returns null.
   public static Player readPlayerFromFile(String fileName)
   {
      try
      {
         ...
         {  
            ...
            weaponHotKeys = new Coord[weaponKeysNum];
            for(int i = 0; i < weaponKeysNum; i++) {
               weaponHotKeys[i] = new Coord(Integer.parseInt(weaponKeyStrings[i * 2]), Integer.parseInt(weaponKeyStrings[i * 2 + 1]));
            }
            ...
            //Line might store no words in the brackets, like "[]", up to any finite number of words like "[blessed, sullied, poisoned, seduced, frozen]"
            ...
            //code to read weapons and weaponFrequencies from file: Lines 18-33
            ArrayList<Weapon> [] weapons = null;
            ArrayList<Integer> [] weaponFrequencies = null;
            //**************TO DO: enter code to process weapons and weaponFrequencies from file: Lines 18-33
            //Note: weapons and weaponFrequencies are standart java arrays where each element of the array will be an ArrayList object.
            //After initializing both java arrays, every element of both arrays will need to be constructed as ArrayLists.
            //There are 16 lines of information that we need to read in from the text file here.  The following code only reads in a single line.
            ...
            weapons = new ArrayList[16];
            weaponFrequencies = new ArrayList[16];
            ...
            //code to read imageIndex from file: Line 34
            byte imageIndex = 0;
            ...
            //code to read startStoryIndex from file: Line 35
            ...
            //code to read mapIndex from file: Line 36
            int mapIndex = 0;
            ...
            //code to read row from file: Line 37
            int row = 0;
            ...
            //code to read col from file: Line 38
            int col = 0;
            ...
            //code to read worldRow from file: Line 39
            int worldRow = 0;
           ...
           //code to read worldCol from file: Line 40
            int worldCol = 0;
            ...
            //code to read locationType from file: Line 41
            String locationType = "";
            line = readInNextLine(input, encoded);               //**locationType
            locationType = line;
                  
            //code to read might from file: Lne 42
            int might = 0;
            ...
            //code to read mind from file: Line 43
            int mind = 0;
            ...
            //code to read agility from file: Line 44
            int agility = 0;
            ...
            //code to read body from file: Line 45
            int body = 0;
            ...
            //code to read manna from file: Line 46   
            int manna = 0;     
            ...
            //code to read awareness from file: Line 47 
            int awareness = 0;        
            ...
            //code to read reputation from file: Line 48
            int reputation = 0;
            ...
            //code to read bounty from file: Line 49
            int bounty = 0;
            ...
            //code to read gold from file: Line 50
            int gold = 0;
            ...
            //code to read experience from file: Line 51
            int experience = 0;
            ...
            //code to read expToLevelUp from file: Line 52
            int expToLevelUp = 0;
            ...
            //code to read weaponSelect from file: Lne 53
            byte weaponSelect = 0;
            ...
            //code to read armorSelect from file: Line 54
            byte armorSelect = 0;
            ...
            //code to read rations from file: Line 55
            byte rations = 0;
            ...
            //code to read numArrows from file: Line 57
            int numStones = 0;
            ...
            //code to read dogBasicInfo from file: Line 58
            String dogBasicInfo = "";
            line = readInNextLine(input, encoded);               //**dogBasicInfo
            dogBasicInfo = line;
         
            //code to read horseBasicInfo from file: Line 59
            line = readInNextLine(input, encoded);               //**horseBasicInfo
            String horseBasicInfo = line;
            
            //code to read npcBasicInfo from file: Line 60
   ...
   public static boolean writeOutPlayerToFile(String fileName)
   {
      ...
      try{
         ...
         float roundedTime = ((int)(CultimaPanel.time * 100))/100.0f;
