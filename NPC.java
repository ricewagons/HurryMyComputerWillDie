...
public class NPC
{
   ...
   public static final byte GORGON = 33;
   public static final byte BEAROWL = 34;
   public static final byte LANDSHARK = 35;
   public static final byte MINDDEVOURER = 36;
   //animals
   public static final byte CHICKEN = 37;
   public static final byte PIG = 38;
   public static final byte BAT = 39;
   public static final byte RABBIT = 40;
   public static final byte ELK = 41;
   public static final byte HORSE = 42;
   public static final byte RAT = 43;
   public static final byte FISH = 44;
   public static final byte SHRIEKINGEEL = 45;  //only spawns in water at night
   public static final byte SHARK = 46;
   public static final byte SNAKE = 47;
   public static final byte SPIDER = 48;
   public static final byte SQUID = 49;
   public static final byte WOLF = 50;
   public static final byte BEAR = 51;
   public static final byte DOG = 52;
   public static final byte PANGOLIN = 53;
   //nature
   public static final byte TORNADO = 54;
   public static final byte WHIRLPOOL = 55;
   public static final byte MAGMA = 56;
   public static final byte DEATH = 57;
   //ships
   public static final byte GREATSHIP = 58;
   public static final byte BRIGANDSHIP = 59;   
   //human 
   public static final byte SORCERER = 60;
   public static final byte BRIGAND_SWORD = 61;
   //no monsters beyond this point will be included in the journal
   public static final byte BRIGAND_SPEAR = 62;
   public static final byte BRIGAND_HAMMER = 63;
   public static final byte BRIGAND_DAGGER = 64;
   public static final byte BRIGAND_CROSSBOW = 65;
   public static final byte BRIGAND_FIST = 66;

   //monster kings and queens
   public static final byte DEMONKING = 67;
   public static final byte DRAGONKING = 68;
   public static final byte TREEKING = 69;
   public static final byte BATKING = 70;
   public static final byte RATKING = 71;
   public static final byte SNAKEKING = 72;
   public static final byte SPIDERKING = 73;
   public static final byte WOLFKING = 74;
   public static final byte BEARKING = 75;
   public static final byte SQUIDKING = 76;
   public static final byte BUGBEARKING = 77;
   public static final byte BRIGANDKING = 78;
   public static final byte BOWASSASSIN = 79;
   public static final byte VIPERASSASSIN = 80;
   public static final byte ENFORCER = 81;
   public static final byte TROLLKING = 82;
   public static final byte PHANTOM = 83;
   public static final byte HYDRACLOPS = 84;
   public static final byte ABOMINABLE = 85;       //the most rare
   public static final byte GOBLINBARREL = 86;     //a goblin hiding in a barrel
   
   public static final byte BARREL = 87;           //we make barrels NPCs so that we can populate levels with them like NPCs and they can be destroyed (killed) and can leave treasure
   public static final byte BOAT = 88;             //simple transport - only vessel that can traverse bog
   public static final byte LICHE = 89;
   
   public static final byte MALEVAMP = 90;         //vampires
   public static final byte FEMALEVAMP = 91; 
   public static final byte WEREWOLF = 92;         //changes to werewolf on clear nights, back to humans in the day

   public static final byte FIRE = 93;             //regular fire (numInfo set to zero) or a fire elemental (numInfo set to non-zero)
   public static final byte STONE = 94;            //stone spire that blocks npcs, can be enchanted into a monolith
   public static final byte MONOLITH = 95;         //stone spires that fry any non-flying thing that goes between them
   public static final byte JAWTRAP = 96;          //placed by player to trap small/medium enemies

   //dinosaurs - in the Jurassica secret realm
   public static final byte PTEROSAUR = 97;
   public static final byte BRACHIOSAUR = 98;
   public static final byte ALLOSAUR = 99;
   public static final byte STEGOSAUR = 100;
   public static final byte PLESIOSAUR = 101;
   public static final byte DILOPHOSAUR = 102;

   //1942/wolfenstein - in the time-travel secret realms
   public static final byte SOLDIER = 103;
   public static final byte OFFICER = 104;
   public static final byte GUARD_DOG = 105;
   public static final byte TANK = 106;
   public static final byte SPITFIRE = 107;

   public static final byte UNICORN = 108;         //only spawns when rainbows are out
   public static final byte BRIGANDRIDER = 109;    //a briggand with an axe riding a horse
   public static final byte TRADER = 110;          //can be found roaming the world or in cities - has a rotating random inventory to trade
   public static final byte CAERBANNOG = 111;      //only spawns at the Cave of Caerbannog!  He's a killer!

   public static final byte DARKKNIGHT4 = 112;     //4 limbs
   public static final byte DARKKNIGHT3 = 113;     //3 limbs   
   public static final byte DARKKNIGHT2 = 114;     //2 limbs
   public static final byte DARKKNIGHT1 = 115;     //1 limb
   public static final byte DARKKNIGHT0 = 116;     //no limbs

   public static final byte NIGHTORC = 117;
   public static final byte EARTHELEMENTAL = 118;
   public static final byte TROGDOR = 119;
   public static final byte CHUD = 120;
   public static final byte MAZEMOUTH = 121;
   public static final byte ROLLINGMENACE = 122;
 
   public static final byte NUM_NPCS = 123;        //can only go up to 127 since it is stored in a byte.  If we want more, we will have to change the charIndex and all character types to ints
...
//returns -99 if not found
   ...
   //monsters
      ...
      if(name.equals("MIMIC"))
         return 32;
      if(name.equals("GORGON")) 
         return 33;
      if(name.equals("BEAROWL")) 
         return 34;
      if(name.equals("LANDSHARK")) 
         return 35;
      if(name.equals("MINDDEVOURER")) 
         return 36;
   //animals
      ...
      if(name.equals("SHRIEKINGEEL")) 
         return 45;  //only spawns in water at night
   ...
   //animals     
      ...
      if(charIndex==DOG)
         return "Dog";  
      if(charIndex==PANGOLIN)
         return "Gold-Pangolin"; 
   //nature    
   ...
   //dinosaurs    
    ...
    //1942/wolfenstein
      ...
      if(charIndex==TROGDOR)
         return "Trogdor the Burninator";       
      if(charIndex==CHUD)
         return "CHUD";      
      ...
      if(charIndex==GORGON)
         return "Gorgon";
      if(charIndex==BEAROWL)
         return "Bearowl";
      if(charIndex==LANDSHARK)
         return "Landshark";
      if(charIndex==MINDDEVOURER)
         return "Mind-Devourer";
      if(charIndex==ROLLINGMENACE)
         return "Rolling-menace";
      return "?";
   }
   ...
   public static List<String> getExpertise(NPCPlayer p)
   {
      ...
      if(p.getName().toLowerCase().contains("puzzle"))
      {
         list.add("puzzle");
      }
      else if(p.getNumInfo()==10)
      {
         list.add("mission");
      }
      ...
      if((p.getLocationType().toLowerCase().contains("village") && CultimaPanel.numNPCsInLoc==1) || p.getLocationType().toLowerCase().contains("domicile"))
      { //hermit
         list.add("training");
         list.add("caves");
      }
      ...
      else if(isGuard(p))
      {
         ...
         else if(p.getLocationType().contains("village") || p.getLocationType().toLowerCase().contains("domicile"))
         {
            list.add("training");
         }
      } 
      ...
      else if(p.getCharIndex()==WISE)
      {
         ...
         else if(p.getLocationType().contains("castle") || p.getLocationType().contains("tower"))
         {
            list.add("underworld");
         }
...
//each elements index must correspond to the NPC character (row) and stat description (col) finals defined above
   ...
   {  //minMight, maxMight, minMind,  maxMind,  minAgili, maxAgili, demeanor (1 or -1)  
      ...
      {90,        120,        20,      30,      40,         50,     -1},    /*GORGON*/
      {200,       250,        4,       6,       35,         40,     -1},    /*BEAROWL */
      {250,       300,        1,       4,       30,         35,     -1},    /*LANDSHARK */
      {25,        35,         3,       5,       35,         45,      1},    /*MINDDEVOURER*/
      ...
      {300,      600,         10,      20,       3,          5,     -1},    /*TROGDOR*/
      {30,        40,         10,      15,      20,         25,     -1},    /*CHUD    */
      {200,      350,         30,      60,      65,         80,     -1},    /*MAZEMOUTH*/
      {50,        75,         4,       6,       80,        100,      1}     /*ROLLINGMENACE   */
      //minMight, maxMight, minMind,  maxMind,  minAgili, maxAgili, demeanor (1 or -1)
      };
...
//each row index must correspond to the finals defined above: row is the monster index, the 5 arrays in each row are the animation frames for facing UP, RIGHT, DOWN, LEFT and the DEAD image
   ...
   {  {{"images/characters/civilians/begger1.Gif", "images/characters/civilians/begger2.Gif", "images/characters/civilians/begger1.Gif", "images/characters/civilians/begger2.Gif"},{},{},{},{"images/characters/civilians/dead.Gif"}}, 
      ...
      {{"images/characters/monsters/medusaLeft1.Gif", "images/characters/monsters/medusaLeft2.Gif", "images/characters/monsters/medusaLeft3.Gif", "images/characters/monsters/medusaLeft4.Gif"},{"images/characters/monsters/medusaRight1.Gif", "images/characters/monsters/medusaRight2.Gif", "images/characters/monsters/medusaRight3.Gif", "images/characters/monsters/medusaRight4.Gif"},{"images/characters/monsters/medusaRight1.Gif", "images/characters/monsters/medusaRight2.Gif", "images/characters/monsters/medusaRight3.Gif", "images/characters/monsters/medusaRight4.Gif"},{"images/characters/monsters/medusaLeft1.Gif", "images/characters/monsters/medusaLeft2.Gif", "images/characters/monsters/medusaLeft3.Gif", "images/characters/monsters/medusaLeft4.Gif"},{"images/characters/monsters/deadMisc.Gif"}},
      {{"images/characters/monsters/owlBearUp1.Gif", "images/characters/monsters/owlBearUp2.Gif", "images/characters/monsters/owlBearUp3.Gif", "images/characters/monsters/owlBearUp4.Gif"},{"images/characters/monsters/owlBearRight1.Gif", "images/characters/monsters/owlBearRight2.Gif", "images/characters/monsters/owlBearRight3.Gif", "images/characters/monsters/owlBearRight4.Gif"},{"images/characters/monsters/owlBearDown1.Gif", "images/characters/monsters/owlBearDown2.Gif", "images/characters/monsters/owlBearDown3.Gif", "images/characters/monsters/owlBearDown4.Gif"},{"images/characters/monsters/owlBearLeft1.Gif", "images/characters/monsters/owlBearLeft2.Gif", "images/characters/monsters/owlBearLeft3.Gif", "images/characters/monsters/owlBearLeft4.Gif"},{"images/characters/monsters/deadClawed.Gif"}},
      {{"images/characters/monsters/landsharkLeft1.Gif", "images/characters/monsters/landsharkLeft2.Gif", "images/characters/monsters/landsharkLeft3.Gif", "images/characters/monsters/landsharkLeft4.Gif"},{"images/characters/monsters/landsharkRight1.Gif", "images/characters/monsters/landsharkRight2.Gif", "images/characters/monsters/landsharkRight3.Gif", "images/characters/monsters/landsharkRight4.Gif"},{"images/characters/monsters/landsharkRight1.Gif", "images/characters/monsters/landsharkRight2.Gif", "images/characters/monsters/landsharkRight3.Gif", "images/characters/monsters/landsharkRight4.Gif"},{"images/characters/monsters/landsharkLeft1.Gif", "images/characters/monsters/landsharkLeft2.Gif", "images/characters/monsters/landsharkLeft3.Gif", "images/characters/monsters/landsharkLeft4.Gif"},{"images/characters/monsters/deadClawed.Gif"}},
      {{"images/characters/monsters/mindDevourLeft1.Gif", "images/characters/monsters/mindDevourLeft2.Gif", "images/characters/monsters/mindDevourLeft3.Gif", "images/characters/monsters/mindDevourLeft4.Gif"},{"images/characters/monsters/mindDevourRight1.Gif", "images/characters/monsters/mindDevourRight2.Gif", "images/characters/monsters/mindDevourRight3.Gif", "images/characters/monsters/mindDevourRight4.Gif"},{"images/characters/monsters/mindDevourRight1.Gif", "images/characters/monsters/mindDevourRight2.Gif", "images/characters/monsters/mindDevourRight3.Gif", "images/characters/monsters/mindDevourRight4.Gif"},{"images/characters/monsters/mindDevourLeft1.Gif", "images/characters/monsters/mindDevourLeft2.Gif", "images/characters/monsters/mindDevourLeft3.Gif", "images/characters/monsters/mindDevourLeft4.Gif"},{"images/characters/monsters/deadMisc.Gif"}},
      ...
      {{"images/characters/animals/pangolinUp1.Gif", "images/characters/animals/pangolinUp2.Gif"},{"images/characters/animals/pangolinRight1.Gif", "images/characters/animals/pangolinRight2.Gif"},{"images/characters/animals/pangolinDown1.Gif", "images/characters/animals/pangolinDown2.Gif"},{"images/characters/animals/pangolinLeft1.Gif","images/characters/animals/pangolinLeft2.Gif"},{"images/characters/animals/deadPig.Gif"}},
      ...
      {{"images/characters/monsters/nonstd/AbominableDown1.GIF", "images/characters/monsters/nonstd/AbominableDown2.GIF", "images/characters/monsters/nonstd/AbominableDown3.GIF", "images/characters/monsters/nonstd/AbominableDown4.GIF"},{"images/characters/monsters/nonstd/AbominableDown1.GIF", "images/characters/monsters/nonstd/AbominableDown2.GIF", "images/characters/monsters/nonstd/AbominableDown3.GIF", "images/characters/monsters/nonstd/AbominableDown4.GIF"},{"images/characters/monsters/nonstd/AbominableDown1.GIF", "images/characters/monsters/nonstd/AbominableDown2.GIF", "images/characters/monsters/nonstd/AbominableDown3.GIF", "images/characters/monsters/nonstd/AbominableDown4.GIF"},{"images/characters/monsters/nonstd/AbominableDown1.GIF", "images/characters/monsters/nonstd/AbominableDown2.GIF", "images/characters/monsters/nonstd/AbominableDown3.GIF", "images/characters/monsters/nonstd/AbominableDown4.GIF"}, {"images/characters/monsters/nonstd/AbominableDead.Gif"}},
      ...
      {{"images/characters/monsters/nonstd/trogdorRight1.Gif", "images/characters/monsters/nonstd/trogdorRight2.Gif", "images/characters/monsters/nonstd/trogdorRight3.Gif", "images/characters/monsters/nonstd/trogdorRight4.Gif"},{"images/characters/monsters/nonstd/trogdorRight1.Gif", "images/characters/monsters/nonstd/trogdorRight2.Gif", "images/characters/monsters/nonstd/trogdorRight3.Gif", "images/characters/monsters/nonstd/trogdorRight4.Gif"},{"images/characters/monsters/nonstd/trogdorLeft1.Gif", "images/characters/monsters/nonstd/trogdorLeft2.Gif", "images/characters/monsters/nonstd/trogdorLeft3.Gif", "images/characters/monsters/nonstd/trogdorLeft4.Gif"},{"images/characters/monsters/nonstd/trogdorLeft1.Gif", "images/characters/monsters/nonstd/trogdorLeft2.Gif", "images/characters/monsters/nonstd/trogdorLeft3.Gif", "images/characters/monsters/nonstd/trogdorLeft4.Gif"},{"images/characters/monsters/deadClawed.Gif"}},   /*TROGDOR*/
      ...
      {{"images/characters/monsters/nonstd/mazemouthUp1.Gif", "images/characters/monsters/nonstd/mazemouthUp2.Gif", "images/characters/monsters/nonstd/mazemouthUp3.Gif", "images/characters/monsters/nonstd/mazemouthUp4.Gif"},{"images/characters/monsters/nonstd/mazemouthRight1.Gif", "images/characters/monsters/nonstd/mazemouthRight2.Gif", "images/characters/monsters/nonstd/mazemouthRight3.Gif", "images/characters/monsters/nonstd/mazemouthRight4.Gif"},{"images/characters/monsters/nonstd/mazemouthDown1.Gif", "images/characters/monsters/nonstd/mazemouthDown2.Gif", "images/characters/monsters/nonstd/mazemouthDown3.Gif", "images/characters/monsters/nonstd/mazemouthDown4.Gif"},{"images/characters/monsters/nonstd/mazemouthLeft1.Gif", "images/characters/monsters/nonstd/mazemouthLeft2.Gif", "images/characters/monsters/nonstd/mazemouthLeft3.Gif", "images/characters/monsters/nonstd/mazemouthLeft4.Gif"}, {"images/characters/monsters/nonstd/mazemouthDead.Gif"}},
      {{"images/characters/monsters/rollUp1.Gif", "images/characters/monsters/rollUp2.Gif", "images/characters/monsters/rollUp3.Gif", "images/characters/monsters/rollUp4.Gif"},{"images/characters/monsters/rollRight1.Gif", "images/characters/monsters/rollRight2.Gif", "images/characters/monsters/rollRight3.Gif", "images/characters/monsters/rollRight4.Gif"},{"images/characters/monsters/rollDown1.Gif", "images/characters/monsters/rollDown2.Gif", "images/characters/monsters/rollDown3.Gif", "images/characters/monsters/rollDown4.Gif"},{"images/characters/monsters/rollLeft1.Gif", "images/characters/monsters/rollLeft2.Gif", "images/characters/monsters/rollLeft3.Gif", "images/characters/monsters/rollLeft4.Gif"}, {"images/characters/monsters/deadMisc.Gif"}}    
      };
 ...
 //***********METHODS TO SEE WHAT KIND OF CHARACTER A PARTICULAR PLAYER IS
   public static boolean hasWeapon(byte charIndex)
   {
      return (charIndex==GUARD_SPEAR || charIndex==LUTE || charIndex==SWORD || charIndex==WISE || charIndex==ROYALGUARD || charIndex==KING || charIndex==GUARD_SWORD ||
               ...
               charIndex==GORGON || isBlackKnight(charIndex));
   }
...
//returns true if the given character index is a common brigand type found in battlefields, monster lairs and the world
  ...
  //returns true if the given character index is a common dosile animal
   ...
   {
      return (type==CHICKEN || type==FISH || type==PIG || type==RABBIT || type==ELK || type==HORSE || type==DOG || type==UNICORN || type==PANGOLIN);
   }
   ...
   {
      return (type==CHICKEN || type==FISH || type==PIG || type==RABBIT || type==ELK || type==HORSE || type==UNICORN || type==PANGOLIN);
   }
   ...
   {
      return (isTameAnimal(type) || type==GUARD_DOG || type==WOLF || type==WOLFKING || type==BEAR || type==BEARKING || type==SQUID || type==SQUIDKING || type==ABOMINABLE || type==PANGOLIN);
   }
...
//for setting the color when we examine a monster
   ...
   {
      return (type==DEMONKING || type==DRAGONKING  || type==TREEKING || type==SPIDERKING || type==CAERBANNOG || type == EARTHELEMENTAL || type == BEHOLDER
         || type==BATKING || type==RATKING  || type==SNAKEKING || type==WOLFKING || type==BEARKING || type == ABOMINABLE || type == GORGON || type == BEAROWL
         || type == TROLLKING  || type == SQUIDKING || type == BUGBEARKING || type == MAGMA || type == HYDRACLOPS || type == TROGDOR || type == LICHE || type == MINDDEVOURER
         || type == BRIGANDKING || type == BRIGANDRIDER || type == BOWASSASSIN || type == VIPERASSASSIN || type == ENFORCER || type == DEATH || type==LANDSHARK);
   }
   
   public static boolean isCityAttackingMonster(NPCPlayer p)
   {
      byte type = p.getCharIndex();
      return (isBrigand(type) || type==TORNADO || type==BUGBEAR || type==CYCLOPS || type==GIANT || type==ORC || type==TROLL || type==WOLFKING || type==BEARKING || type==DEMONKING || type==SKELETON || type==SNAKEKING || type==RATKING || type==SPIDERKING || type==BUGBEARKING || type==TROLLKING || type==DRAGON || type==DRAGONKING || type==BEAROWL || type==LANDSHARK);
   }
   ...
   public static boolean isFeedableMonster(byte type)
   {
      if(CultimaPanel.player.getRations()>=5 && (type==WOLF || type==RAT  || type==BEAR || type==GUARD_DOG || type==BUGBEAR  || type==ORC  || type==NIGHTORC || type==DILOPHOSAUR || type==PIG || type == ABOMINABLE))
         return true;
      if(CultimaPanel.player.numFlowers()>=5 && (type == UNICORN || type==PANGOLIN))
         return true;
      return false;
   }
...
//returns true if the monster makes a stomping sound
   ...
   {
      return (type==BEAROWL || type==LANDSHARK || type==DEMONKING || type==DRAGONKING || type==TREEKING || type==SPIDERKING  || type==BEARKING || type==GIANT || type==TROLLKING || type == DEATH || type==BRACHIOSAUR || type==ALLOSAUR || type==STEGOSAUR || type == ABOMINABLE || type==TROGDOR || type == EARTHELEMENTAL);
   }
  ...
  //returns true if the character index is any kind of water vessel
   ...
   {
      return (charInd==BEAROWL || charInd==LANDSHARK || charInd==DEMONKING || charInd==DRAGONKING || charInd==TREEKING || charInd==BATKING || charInd==RATKING || charInd==SNAKEKING || charInd==SPIDERKING || charInd==WOLFKING || charInd==BEARKING || charInd==BRIGANDKING  || charInd==BUGBEARKING || charInd==TROLLKING || charInd==MAGMA || charInd==DEATH || charInd==HYDRACLOPS || charInd==LICHE || charInd==CAERBANNOG || charInd==TROGDOR || charInd==EARTHELEMENTAL);
   }
  ...
  //returns true if the character index is a boss monster in KAIJU mission
   ...
   {
      byte charInd = p.getCharIndex();
      return (charInd==TROGDOR || charInd==EARTHELEMENTAL || (charInd==TORNADO && (p.getNumInfo()!=0 || p.hasItem("essence"))));
   }
   ...
   {
      byte pc = p.getCharIndex();
      return (pc==BEAR || pc==BEARKING || pc==WOLF || pc==WOLFKING || pc==RAT || pc==RATKING || pc==BUGBEAR || pc==BUGBEARKING || pc==LANDSHARK
           || pc==DRAGON || pc==DRAGONKING || pc==GIANT || pc==ABOMINABLE || pc==BAT || pc==BATKING || pc==SNAKE || pc==SNAKEKING
           || pc==TROGDOR || pc==ALLOSAUR || pc==DILOPHOSAUR || pc==CAERBANNOG || pc==HYDRACLOPS || pc==GUARD_DOG || pc==BEAROWL);
   }
   ...
   public static float getSize(byte type)      
   {
      ...
      if(type==CYCLOPS || type==DRAGON || type==TREE || type==SQUID || type==BRIGANDSHIP || type==TROLL || type==STONE || type==MONOLITH || type==TRIFFID || type==BEHOLDER || type==BRIGANDRIDER || type==MAZEMOUTH)
         return 1.5f;
      if(type==DEMONKING || type==BATKING || type==RATKING || type==WOLFKING  || type==BEARKING || type==BUGBEARKING || type==PLESIOSAUR || type==GORGON)
         return 1.5f;
      if(type==DRAGONKING || type==TREEKING || type==SNAKEKING || type==SPIDERKING || type==SQUIDKING || type==TROLLKING || type==ALLOSAUR || type==STEGOSAUR)
         return 2.0f;   
      if(type==GIANT || type==SEAMONSTER || type==GREATSHIP || type == DEATH || type == TANK || type == BEAROWL || type == LANDSHARK)
         return 2.0f;  
      if(type == ABOMINABLE)
         return 2.5f;  
      if(type==BRACHIOSAUR || type==HYDRACLOPS || type==TROGDOR || type==EARTHELEMENTAL  || type==TORNADO || type == SPITFIRE)
         return 3.0f;   
      return 1.0f;
   }
   
   //returns the size of the NPC for drawing to scale in world view depending on distance
   public static float getSize(NPCPlayer npc)      
   {
      if(npc.getCharIndex() == FIRE)
      {
         float percentHealth = (float)npc.getPercentHealth();
         float maxSize = 2.0f;
         float minSize = 0.5f;
         float size = (percentHealth * (maxSize - minSize) / 100.0f) + minSize;
         return size;
      }
      ...
      if(npc.getCharIndex() == RUSTCREATURE || npc.getCharIndex() == MINDDEVOURER)
      {
   ...
   public static String isMonster(String typed)
   {
      ...
      if(typed.contains("SPIDER"))
         return "SPIDER";
      if(typed.contains("SQUID") || typed.contains("OCTOPUS") || typed.contains("KRAKEN"))
         return "SQUID"; 
      ...
      if(typed.contains("MIMIC"))
         return "MIMIC";
      if(typed.contains("GORGON") || typed.contains("MEDUSA"))
         return "GORGON";
      if(typed.contains("BEAROWL") || typed.contains("OWLBEAR") || (typed.contains("OWL") && typed.contains("BEAR")))
         return "BEAROWL";
      if(typed.contains("LANDSHARK") || (typed.contains("LAND") && typed.contains("SHARK")))
         return "LANDSHARK";
      if(typed.contains("MINDDEVOURER") || (typed.contains("INTELECT") && typed.contains("DEVOUR")))
         return "MINDDEVOURER";
      if(typed.contains("PANGOLIN"))
         return "PANGOLIN";
      if(typed.contains("ROLLING") && typed.contains("MENACE"))
         return "ROLLINGMENACE";
      return "?"; 
   }
...
//movement types
   ...
   public static final String[] bribeMaybe = {"Tis not horable...but...ten gold is just not enough.", "Tis insufficient.  Ten gold is not enough!", "Thee shalt have to do better than ten gold.", "Ten gold?  Tis too small a price."};
   public static final String[] bribeYes = {"Speak nothing of this...", "Tis good pay...", "Thee shalt not tell my superiors...", "Tis a fair price..."};
   ...
   public static final String[] helpTrogdor = {"Run for thy lives! Tis Trogdor!", "Save my thatch-roof cottage!", "And the Trogdor comes in the Night!", "Trogdor!", "Trogdor is burninating the peasants!", "Trogdor is burninating all the peoples!", "No! All the thatch-roof cottages!"};
   ...
   public static final String[] npcFollow = {"I shall follow you closely now", "Yes, I will follow thee", "Indeed, let us resume our journey", "Lead the way"};
   ...
   public static final String[] npcSwamp = {"My boots are getting wet!", "ADJECTIVE bog!", "I'm sinking!", "Smells like death!"};
   ...
   public static final String[] mainMission = {"<...seek the NUMBER of Skara Brae...>", "<...seek the red square made of four...>", "<...remember thy visions...the NUMBER...>", "<...SKARA Brae calls thee to the redened square...>"};
   ...
   public static final String[] fiftyResponseNo = {"That number sounds familiar", "I have seen that number...in my dreams", "This number rings strange in my ears", "That number...it sounds true to me", "I have seen this number, multiplied upon itself in my dreams"};
   public static final String[] horseNo = {"I know not of those beasts - ask the Royal Guard", "Wild horses are a mystery to me, but the Royal Guard knows", "Tis the Royal Guard that tames wild horses", "I have seen the Royal Guard tame them in the wild"};
   public static final String[] shipNo = {"Ask the CITY guards about them, I have not spent time on one", "Some CITY guards use to work the ships", "I know of some CITY guards that have sailed before: ask them", "I have only seen ships from the dock, but some CITY guards are former sailors","The shoppekeep at the Port-town is in the buisness of ships", "Seek the shoppekeep of the Port-town about ships.", "Tis the Port-town shoppekeep that trades gold for vessels", "Our local Port-town shoppekeep is in ship sales"};
   ...
   public static final String[] caveInfo = {"The most rare of mountain caves - green with unnatural moss",
                           ...
                           "Portals to other worlds and times await thee in the green caves",
                           "On even days, portals are a gateway across the lands of Cultima",
   ...
   public static final String[] luteDestiny = {"Nigel's Lute Of Destiny: tis said that songs played on it can CHARM most two-legged beasts", "Nigel's Lute Of Destiny is able to CHARM even the TROLL", "Nigel's Lute Of Destiny is famous for its sustain", "Nigel's sound is soo sweet, a charging cyclops t'would take time to listen", "Nigel's Lute Of Destiny is the most coveted of instruments: can CHARM even the giants", "Sir Nigel Tufnel, the finest lute player to have ever graced the air of CULTIMA", "If it walks on two legs, odds be that it can be charmed by Nigel's Lute of Destiny", "When Nigel played the three sacred songs of Skara Brae, even Royal Guard were drawn to dance"};
   public static final String[] wellsPuzzle = {"The Puzzle-Giver of the Three Wells Puzzle rests in the UNDERWORLD!", "This Three Wells Puzzle of the UNDERWORLD: are there not waters 'round the island?", "Perhaps one can trick the Puzzle-Giver of the UNDERWORLD to drink only one poison...", "Remebmer, the cure to any poison is a higher poison!", "One must think off the island for the Three Wells Puzzle...", "What if one filled thy goblet from the waters 'round the island?", "The UNDERWORLDS Puzzle-Giver will likely draw from Well-Three!", "Is it not true that the poisons from Well-Three are the cure to lower poisons?"};
   public static final String[] doorsPuzzle = {"The Three Doors Puzzle is given by the Puzzle-Bringer, a cunning Sorcerer", "The Puzzle-Bringer lives in a temple DUNGEON, and offers the Three Doors Challenge", "This Three Doors Challenge seems a simple matter of chance, but the wise will know better", "Challengers of strong numerics know where the best chances lie", "There is quite a gap between one-of-three and two-of-three, thy odds that gold thee will see", "The Three Doors Puzzle was first told to me by Daryl Python. Or was it Monty Daryl...maybe Python Hall"};
   ...
   public static final String[] rationsNegative = {"Rations for coin.", "Is thou going to buy rations, or just linger about?", "I am here to sell rations, not watch thee gallop around my shoppe!", "If thee needs rations, show me coin!", "Thy stock of rations be full - I hope your pockets are not empty!", "Doth thou have coins, or perhaps PANGOLIN scales to trade?"};
   ...
   public static final String[] magicNegative = {"Potions for coin.", "Does thou need a potion, a cure, or just a spot to get in thy customer's way?", "If thou has no coin to spend, I will make thee disappear...", "I can cure thy sickness, but not thy sullen face.", "Doth thou have coins, or perhaps PANGOLIN scales to trade?"};
   ...
   public static final String[] armsNegative = {"Arms for coin.", "If thee breaks, thee buys!", "If thee intends to buy arms, lets get on with it!", "If thee has no coin, I need the space thee occupies to fill with proper customers!", "Coin for steel - simple rules for thy simple mind!", "Doth thou have coins, or perhaps PANGOLIN scales to trade?"};
   ...
   public static final String[] tavernNegative = {"Mead for coin.", "Hey PLAYER_NAME! Wipe thy grimy boots at the door!", "Is thee here to drink or just take up thy time?", "If thee has no coin, thee has no buisness here, PLAYER_NAME!", "Are thy pockets empty? The door to exit is over there!", "Doth thou have coins, or perhaps PANGOLIN scales to trade?"};
   ...
   public static String[] monsters = {"I have seen a BEAST wander through the gates of this very town",    
      ...
      "These Goblins - not unlike shortened men, but twisted and green ~~GOBLIN", "One can find devilish Goblins in thy DUNGEON, sneaky creatures they are ~~GOBLIN", "Goblins are known to skulk in the dark, and hide within barrels to sneak up on thee ~~GOBLIN", "To a well armed adventurer, one Goblin is an annoyance.  Many Goblins are trouble ~~GOBLIN", "These Goblins are fearful of light, even that cast from a SPELL ~~GOBLIN",
      ...
      "The mighty Cyclops carries a crushing club ~~CYCLOPS", "The one-eyed beast roams the plains and forests, but live in darkened CAVE ~~CYCLOPS", "The hulking Cyclops, clumsy and dim, but powerful, is quite afraid of water ~~CYCLOPS", "Tis said the beastly, one-eyed man can be charmed by music ~~CYCLOPS", "While powerful, thy Cyclops is not terribly graceful, and worse so when rain falls ~~CYCLOPS", "The terrible armies of BRIGAND and TROLL often employ a powerful Cyclops in their ranks ~~CYCLOPS",
      "Fearsome Demons are said to haunt darkened dungeons and temples erected for evil ~~DEMON", "A Demon's claw can lay a curse on thee ~~DEMON", "Demons are not bothered by flame, but dislike the cold ~~DEMON", "Tis best to carry a Pentangle if thee must battle grim Demons ~~DEMON", "The Demons are of high MIND, and will not be fooled by charms, or even invisibility ~~DEMON", "Demons must be close to attack, and can teleport closer to thee in a flash of fire ~~DEMON", "If ye encounter a demon that speaks, dare not take the challenge to a game of Swine, lest thee lose thy life ~~DEMON", "Even powerful Demons answer to a greater Demon King, and possibly more ~~DEMON", "Tis said the Demon King carries a flaming sword, and can summon demonic minions ~~DEMON", "Legend tells of a Demon King that can summon an evil mimic of its challenger ~~DEMON", "These Demons are as vile as they come, but they have strange ties to the Great SKARA Brae ~~DEMON",
      
      "A feast? Why yes, I am quite hungry, thank you",
      "You can purchase all this knowledge at once with my monster's MANUAL",
      
      "Best be not tangle with Dragons: they are swift and mighty ~~DRAGON", "With thy Dragon, stay out of line with its fire, run serpentine, and seek shelter with haste ~~DRAGON", "One can hide from high-flying Dragons in deep forests, or seek refuge in shallow water ~~DRAGON", "While Dragons prefer open air, they have been known to nest in a massive CAVE ~~DRAGON", "The prized Dragon's EGG is said to have magic powers, perhaps if eaten ~~DRAGON", "You might hear the shrieking call of the Dragon before seeing it - if so, seek cover ~~DRAGON", "We have never seen a Dragon in a driving rain ~~DRAGON", "Tis said Dragons wince from the cold ~~DRAGON", "The city Ironsmith can CRAFT a Dragon's scales to armor: totally resistant to flame ~~DRAGON", "Tis whispered that even the mighty Dragons have a larger queen that rules them all ~~DRAGON", "Nobody has lived to tell of encountering Dragon royalty, but with charred remains ~~DRAGON", "The Queen of Dragons is unmatched, save Death, Trogdor and the Beast of CAERBANNOG ~~DRAGON",
      ...
      "There is something strange in the sands - a beast that grabs from below ~~GRABOID", "The Sand-grabber is said to descend from the ropers, but 'neath the earth ~~GRABOID", "Sand-grabbers move only through dry grass and loose sand - they cannot pass under wet, rooted or rocky ground ~~GRABOID", "When traveling across desert plains, watch for movement in the sand to avoid the Grabbers ~~GRABOID", "The Sand-grabbers have never been encountered when rain falls, nor at night ~~GRABOID", "Tis said the hides of digested creatures and treasures of travelers can be found within the gizzards of a slain Sand-grabber ~~GRABOID", "Tales speak of a mighty adventurer, swallowed whole by a Graboid to cleaved her way out of the beast before being digested alive ~~GRABOID",
      "Massive, trollish men are known to smite travelers caught off-guard in the plains, but live in a torch-lit LAIR ~~TROLL", "These Trolls can swing a mighty club ~~TROLL", "Trolls are known to snatch away villagers as prisoners in a darkened, monstrous LAIR ~~TROLL", "Troll armies have been spied marching across the foothills ~~TROLL", "Against the Troll army, tis best to move serpentine as to not get cornered ~~TROLL", "Best to engage a Troll army in the rain - these brutes are quite clumsy on wet ground ~~TROLL", "The Troll army is captained by their fearsome king, massive, who swings the LEGENDARY Banehammer ~~TROLL",                                        
      "The local fowl are not monsters, they are owned by the villagers ~~CHICKEN", "A fowl can make for a fine days RATION ~~CHICKEN", "The village chickens are sometimes killed by DOG ~~CHICKEN", "One learned to train a DOG to stealthily hunt local chicken for her RATIONS ~~CHICKEN",
      
      "Dost thou even slay beasts, brother?",
      "My monster's MANUAL is available at all fine retailers. I have one right here for purchase...",
      ...
      "My monster's MANUAL is worth ten times its weight in PANGOLIN scales",
      ...
      "The wild horse of the plains are swift and powerful ~~HORSE", "These grazing creatures are not wicked beasts, and tis said the Royal Guard knows how to tame them ~~HORSE", "Horse riders do not ride a wild horse into battle - they will discharge their riders if struck upon ~~HORSE", "The Royal Guard on horseback can cover great distances in short time ~~HORSE", "Legend tells of a horned horse that appears when colors arch across the sky ~~HORSE", "The secrets of the Unicorn are known only by the Royal Guard of the Capital ~~HORSE",
      "What about the R.O.U.S.'s ~~RODENT","Rodents Of Unusual Size? I don't think they exist ~~RODENT",
      "The mystical Gold-Pangolins are highly prized, seized by greedy Royalty to pad their coffers ~~PANGOLIN", "Sacred Pangolins are quite rare, as their golden scales are a source for our currency ~~PANGOLIN", "You might recognize that many of our coins are punched from the scales of the Gold-Pangolins ~~PANGOLIN", "If lucky enough to see one in the wild, dare not strike at it for it will roll away with a mighty force ~~PANGOLIN", "Our mages have a special understanding of the Gold-Pangolin and feed them flowers from their Floretbox ~~PANGOLIN", "Ask the local mages about these Gold-Pangolins, for they are wise about many mysteries ~~PANGOLIN", "I have seen a Golden-Pangolin in its excitement of eating tossed florets, shed some golden scales ~~PANGOLIN",
      ...
      "Beware wading in the shallows at night, for you may come into sights of the Shrieking eels ~~SHRIEKINGEEL", "Named after the wail that is heard as they draw close, tis the Shrieking eel ~~SHRIEKINGEEL", "Shrieking eels are the nocturnal cousins of beastly sharks - not as strong but faster of fin and harder to see ~~SHRIEKINGEEL", 
      "Wade not too long in the waters - beastly fish will thrash at thee ~~SHARK", "Even the water's edge is not safe from sharks - they will thrash at a dragging foot if they can ~~SHARK", "Use a WEAPON of at least a spear's length to hunt the beastly fish of the rivers and seas ~~SHARK", "If thee dares to hunt the beastly fish, lure him to shallow waters so you can carve its meat for RATIONS ~~SHARK",
      "Coiling serpents have been seen many places: forest, temple, CAVE and DUNGEON ~~SNAKE", "Most serpents will pay you no mind if thee keeps good distance ~~SNAKE", "Get not too close to serpents unless thee has a poison's CURE ~~SNAKE", "A serpent EGG are used to make CURE potions, and may even work if eaten in the raw ~~SNAKE", "The snakes sleep in winter. Tis rare to see them in snow ~~SNAKE", "Serpents the length of twenty men have been told in tales, known to swallow adventurers whole ~~SNAKE","These serpents large and small move easily in the rain, much harder to smite ~~SNAKE",
      ...
      "Much larger than common house spiders, those of the CAVE range from gentle to insidious ~~SPIDER", "Large CAVE spiders can deliver a sticky web and poisonous bite, but fear the light ~~SPIDER", "Many spiders will leave thee alone unless attacked ~~SPIDER", "When venturing into a spider-nested CAVE, tis best to carry a poison's CURE ~~SPIDER", "The spiders answer to their colossal queen, massive and feared across the land ~~SPIDER",
      "The great Kraken are intelligent, powerful and not always knavish ~~SQUID", "The giant Kraken can reach a spear's length with their many arms ~~SQUID", "The most rare of creatures is the gargantuan Kraken, but not all are evil ~~SQUID",  "Tis said the legendary garganuan Kraken holds in its gizzard the most powerful magic pearl in creation ~~SQUID", "No, no...you should not release the Kraken... ~~SQUID",               
      "The wild wolfen have a powerful bite, and will swiftly chase down any fool that dares attack ~~WOLF", "A lone wolfen is common in the brush and plain, but packs have been seen from the forests to the temples ~~WOLF", "Some wolfen of the forest will attack when hungry or frightened, but most will leave you be ~~WOLF", "Wearing a wolfen hide might allow you to evade them and shield thee from blowing Winter snow ~~WOLF", "Our local ironsmith will TRADE you wolf pelts for coin or PANGOLIN scale ~~WOLF", "Dare not attack the wolfen when clothed in its hide, lest you tempt the Wolfen curse ~~WOLF", "If hunted by the Wolfen pack, toss a RATION to end their pursuit of thee ~~WOLF", "A hungry wolf will sight thee faster if you tread up WIND of the beast ~~WOLF", "They who travel with DOG will find little trouble from Wolfen ~~WOLF", "A great mage once traveled with Wolfen, said to don wolf hide and know the TAMEANIMAL spell ~~WOLF", "Tis said that the wolfen pack is ruled by a much larger queen ~~WOLF",
      ...
      "A water vortex is a spinning current that has been the end of many reckless sailors ~~WHIRLPOOL", "The swirling chaos of the water vortex is mindless and cannot be harmed by any weaponry nor MAGIC ~~WHIRLPOOL", "A water vortex was seen to pull the water from a deep channel, making it able to cross ~~WHIRLPOOL",
      ...
      "The shores of port cities are protected by great sailing ships, which house powerful cannons ~~GREATSHIP", "Stay out of line of the great ship's cannons when advancing position ~~GREATSHIP", "All creatures, save flying Dragons, will quickly wilt from cannon fire ~~GREATSHIP", "The great ship has a strong wooden hull, but travels more slowly than the lighter Brigand ships ~~GREATSHIP", "Ask thy CITY guards about ships - some have worked on them prior to their post ~~GREATSHIP",
      "The Brigands carry their villainy to the seas in swift, cannon wielding ships ~~BRIGANDSHIP", "Tis said that a great hero once overtook a brigand's ship, all on her own ~~BRIGANDSHIP", "The Brigand's ship moves quickly, but has a lighter armored hull ~~BRIGANDSHIP", "The Brigand's ship's hull is made of earthen wood - might be wilten to fire ~~BRIGANDSHIP", "Seafaring Brigands prize the magic holdall to store the goods they steal from villages ~~BRIGANDSHIP", "Some port cities and villages have been plagued by the feared Dread Brigand Roberts ~~BRIGANDSHIP", "Drunken Brigands are known to brag of maps to great treasures on their SHIP ~~BRIGANDSHIP",
      
      "Few know of the bog-dwelling Triffids, massive flowers that move as if animal ~~TRIFFID","Tis said Triffids can only travel in swamp and are noble defenders of the wetland ~~TRIFFID"," The threatened Triffid can lash out with coiling branches and choke thee with a cloud of spore ~~TRIFFID","The Triffid's poison will confuse its victim, and rob thee of balance as if sullied ~~TRIFFID",     
      "Most rare of the dungeon, only strange tales speak of a floating monstrosity with many eyes ~~BEHOLDER", "Beware, thy Beholders are said to command the most powerful of magics, challenging that of the most adept mage ~~BEHOLDER", "The mere gaze of a beholder can plague thee with psionic attacks, draining thy manna or thy very life ~~BEHOLDER", "With such a highly trained mind, the Beholder is likely immune to curses or possession ~~BEHOLDER", "Tis best to close ranks on a Beholder quickly, striking before it can unleash its magic on thee ~~BEHOLDER", "When threatened in close quarters, the Beholder can teleport away to a safe distance to strike at thee ~~BEHOLDER", 
      "The most strange of beasts, the Mind-Devourer is not from this realm ~~MINDDEVOURER", "We know not how the Mind-Devourer sees, perceives or thinks. Tis a mystery ~~MINDDEVOURER", "The Mind-Devourer roams dungeons, lairs and seen rarely around ancient temples ~~MINDDEVOURER", "If you happen across a Mind-Devourer, do not approach lest thee lose thy capacity for magic ~~MINDDEVOURER", "For those of shallow intellect, a Mind-Devourer will pass thee by as if you did not exist ~~MINDDEVOURER", "Woe be to the mage that runs afoul a Mind-Devourer - the higher their intellect, the more aggressively will they pursue ~~MINDDEVOURER", "The strike of a Mind-Devourer will tear the very acuity from thy mind ~~MINDDEVOURER",
      ...
      "Just a regular treasure chest? Or is it...might be a Mimic in disguise ~~MIMIC", "These Mimics lie in wait, lie in more way than one, to ambush a carefree adventurer ~~MIMIC", "While the Mimic might appear as a still chest of goods, gnashing teeth await the hand that moves to open its lid of a mouth ~~MIMIC",  "Those of strong awareness might detect the Mimic's breathing or the slightest twitch before getting too close ~~MIMIC",  "Examine any treasure closely before touching. Could be trapped, or worse, a Mimic ~~MIMIC",
      "Sisters of the Serpent-Queen, the Gorgons haunt the most dangerous of dungeons ~~GORGON", "The Gorgon sisters carry magic bows to strike from range, but hide more insidious powers within their glowing eyes ~~GORGON", "To meet the gaze of one of the Gorgon sisters is to be instantly cast to stone ~~GORGON", "One must have a mirrored weapon readied to deflect the Gorgon's deadly gaze ~~GORGON", "The death that follows a Gorgon's sight is permanent, even if thee holds a sacred Life-Pearl ~~GORGON", "To defeat a sister of the Gorgons is to match a feat only spoken of in high tales ~~GORGON",
      "The strongest of the forest beasts be the mighty Bearowl ~~BEAROWL", "Tis a massive bear with a fanged beak! Must be the meddeling of sorcerers with nature ~~BEAROWL", "No meleed arms are a match for the Great Bearowl! Best thee run and seek a place to hide ~~BEAROWL", "The Bearowl has a keen sense of smell, so stay down or cross WIND of the beast ~~BEAROWL","Thy only chance against the rare Bearowl is to attack with fire or poison from great range ~~BEAROWL",
      "Another aberration of nature from the meddling of Sorcerers, the rare Landshark bows to none ~~LANDSHARK", "The thick armor of the Landshark makes it impervious to most weapons, fire, poison and frost ~~LANDSHARK", "The Landshark has only one weak spot, their eyes ~~LANDSHARK", "A Blinding light spell will open up a short window of opportunity to land an arrow or spear ~~LANDSHARK", "When blinded, the Landshark will widen its eyes in an attempt to see, and a well aimed arrow or spear can be launched at it ~~LANDSHARK", "Once thou casts a Blindinglight spell at the Landshark, ready thy ranged weapon and go for the eyes boo ~~LANDSHARK",
      "If you spy a darkness approaching thee, run! Tis DEATH herself! There is no battle to be fought, only retreat ~~DEATH", "Death can only be evaded! Thou cannot battle her, lest ye be Killed by DEATH", "If Death comes for thee, run and hide! A CITY, CAVE, SHIP... ~~DEATH", "Tis said that only a crowned agent of SKARA Brae herself can challenge Death ~~DEATH", "In tales of lore, SKARA Brae wounded Death with a silver-forged royal weapon, charged with a sacred pearl ~~DEATH", "No spell that inflicts damage can make DEATH vulnerable, but perhaps its opposite can... ~~DEATH", "The only day safe from her sights is the holy HOLIDAY, SKARA Brae Day ~~DEATH", "The Royals are wise and may know more about this most unholy of aberrations ~~DEATH",       
...
//numbers after the "~~" for each item denote the integer value of the NPC it is about (for generating the journal), -1 denotes general knowledge
   public static String[] tavernTown = {"Harm not these townsfolk, lest ye build a bounty that casts an ASSASSIN on thee ~~MISC", 
        ...
        "The ratty children: they are of little use ~~CHILD", "Some townsfolk have gone missing, parents who leave behind frightened children in need of help ~~CHILD", "Little information can be gained from the city children, lest it be their age or favorite color ~~CHILD",
        ...
        "Our local mages make a fine poison CURE for those that stumble into a DUNGEON trap, or run afoul a viper ~~WISE", "The mages of magic shoppes can CURE your ills, or teach you a SPELL for coin or PANGOLIN scale ~~WISE", "Tis said mages in some places can TRAIN you to fortify thy MIND ~~WISE", "Our local wisemen can predict the very rain - ask them about WEATHER before a long journey ~~WISE", "Some Mages can see into the very FUTURE, and will tell you of battles to come when asked ~~WISE", "A poor wiseman revived with coin or rations might teach you for a SPELL ~~WISE", "I hear the local mages mumble something about a NUMBER ~~WISE", "Mages often travel to distant shrines and temples ~~WISE", "For help finding your way to cities, ask temple visitors and mages about their HOME and they will augment thy MAP ~~WISE",
        "The women of the cities and villages might mark thy MAP for no more than five coins ~~WOMAN", "The towne baker is wise in the skill of mapping and might share that information if asked ~~WOMAN", "I have seen the town DOG respond to the commands of the lady of the CASTLE ~~WOMAN", "This lady of the CASTLE may know the fine art of training dogs ~~WOMAN", "There is said a woman at the temple who knows quite well the WOLFEN curses",
        ...
        "The Royal Guards carry a fine sword and shield - and are famous for taming wild HORSE ~~ROYALGUARD", "Step not on the toes of a Royal Guard: they are MIGHTY in battle ~~ROYALGUARD", "If drafted to defend a CITY against a BRIGAND army, tis an honor if you fight alongside a Royal Guard ~~ROYALGUARD", "The Royal Guard watches closely any who approach the King. Do not unsheathe thy WEAPON near royalty ~~ROYALGUARD", "The Royal Guard's sword is forged with silver, the WOLFEN slayer ~~ROYALGUARD", "Any Royal Guard will be impressed enough to talk to thee with a royal sceptre in thy hands ~~ROYALGUARD",
        
        "Tis but one COIN for a drink",             
        
        "Be sure to pay the Taxman when approached, lest the guards be called, thee soil thy reputation and build a bounty ~~TAXMAN", "Taxes for most towns are due each season, ten percent thy carried gold ~~TAXMAN", "Own a home and thy quarterly property tax will pay for city services - twenty gold per season ~~TAXMAN", "The Taxman collects when the sun shines, rarely out in the rain, so precious is he ~~TAXMAN", "Help the Taxman collect on debters and thy own taxes might be overlooked for the season ~~TAXMAN", "Swiftness has graced our Taxman, built from chasing down those with debt ~~TAXMAN", "When thy Taxman is on march, mind his direction so thee can evade his sight ~~TAXMAN", "Tis said that some wicked tax collectors are afraid of dogs ~~TAXMAN",
        
        "Royalty will pay in gold for dangerous duties, but some common folk might have some work for pay as well ~~KING", "Our royalty carries a fine staff, tis said to have magic qualities ~~KING", "Do not approach Royalty with thy WEAPON in hand, nor use cursed words - well trained guards are sensitive to any threat ~~KING", "Dare not threaten Royalty of the CASTLE, lest you face the guards, and a bounty is placed on thy head ~~KING", "The Vile Duke of distant lands is known to send adventurers on the most wicked of tasks ~~KING", "To carry a royal staff is to be given an audience with any Royalty, regardless of reputation ~~KING", "The King of all Cultima lives in the CASTLE of the capital ~~KING", "King Garriott knows all of Cultima, very wise is he ~~KING",
...
//numbers after the "~~" for each item denote the integer value (Player.imageIndex) of the weapon it is about (for generating the journal), 0 for armor, -1 for general knowledge
   public static String[] armsInfo = {"The torch is essential for exploring mine and CAVE to cast light on darkened areas ~~TORCH", "The torch does not offer thee much striking power or defense, but can alert you to foes that advance from the shadows ~~TORCH", "Some creatures are bothered by flame, and a good swipe with a torch may inspire retreat ~~TORCH", "Take care with the torch when close to materials that take to flame - wood, straw, bedding, lest you start a terrible fire ~~TORCH", "Thy torch will offer no light in a driving rain, so do not travel on a stormy night ~~TORCH", "A strong warrior can wield the rare Toothed-torch, which strikes as a mace, but lights with flame ~~TORCH", "One can waive and thrust a torch around to intimidate or frighten small beasts, or even villagers ~~TORCH", "Be mindful waiving thy torch in town, lest the guards and adventures take notice. They are unlikely to be intimidated ~~TORCH", "Tales are told of Gada, a mace of legend that burns as a torch ~~TORCH",
      ...
      "A sword in each grip can slash at foes faster than one ~~DUALBLADES", "With an advantage of speed, short swords hit not with the same damage as a longsword ~~DUALBLADES", "A dextorous adventurer with dual blades can attack in a spin, hitting more than one foe ~~DUALBLADES", "The Briggand King is swift and MIGHTY enough to carry dual swords ~~DUALBLADES",
      ...
      "The flamed and bright weapons will light a dark CAVE ~~MISC",
      ...
      "The Iron-bracer will also protect an adventurer as an additional piece of armor ~~GLOVE",
...
//only elements that contain "~~" should be added in the journal
   public static String[] spellInfo = {"Thee needeth a staff to hold spells that are directed at targets ~~STAFF", "A mage's staff is bound to the soul: once owned, you cannot drop it ~~STAFF", "Thy staff can know spells beyond your reach: thee will only see that which can be cast ~~STAFF", "The mage's staff can strike at a range of two arms lengths, but is made for directing spells ~~STAFF", "When joined with the most rare of magic stones, thy staff can stun enemies and enhance the caster's directed spells ~~STAFF",
      ...
      "The Cure incantation will purge a poison that boils within ~~CURE", "One can be poisoned by vipers, spiders, deadites or insidious DUNGEON traps ~~CURE", "Also seek cure potions to save thy manna to keep the beasts at bay ~~CURE", "If a companion is poisoned, thy Cure incantation will be cast upon them if close enough ~~CURE",
      "The powerful Restore chant will HEAL both thy flesh and blood ~~RESTORE", "Restore requires more manna than thy Heal and Cure spell, so cast it only in the most grave of times ~~RESTORE", "The Restore incantaion will use as much manna as needed to heal thy body ~~RESTORE",
      ...
      "A staff's Curse command will make a target less adept ~~CURSE", "These vile demons strike with powerful curses of their own, yet they have strange ties to SKARA Brae ~~CURSE", "Cursing a beast will make it more vulnerable in combat ~~CURSE", "Thy Curse spell is never taught by fellow mages ~~CURSE", "One must win a game of Swine against a grim Demon to learn the Curse spell for thy staff ~~CURSE",
      ...
      "Thy staff's Fireball can launch flame at range, setting a foe ablaze ~~FIREBALL", "To ready one's staff with a Fireball strike will render a darkened CAVE alight ~~FIREBALL", "Set a foe ablaze with Fireball, and retreat while the flames accumulate damage upon their hides ~~FIREBALL", "The flame spells are less effective against grim dragons and demons ~~FIREBALL", "Fireball is quite less effective when cast in falling rain ~~FIREBALL", "Fireball cast with fully charged manna is quite powerful and may damage those close to its target ~~FIREBALL", "Take caution: fire will destroy the prized FUR of any game that is cast upon ~~FIREBALL",
      "A staff's Icestrike can slow a foe at range with piercing cold ~~ICESTRIKE", "Icestrike does more harm in a driving rain ~~ICESTRIKE", "A HOUSE in flame can be smothered with an Icestrike spell ~~ICESTRIKE", "A sea serpent is less bothered by Icestrike, but withers from thy staff's Fireball ~~ICESTRIKE", "These demons and dragons that roam the land will be tested by the Icestrike spell ~~ICESTRIKE", "To cast Icestrike with full manna will damage those close to thy target ~~ICESTRIKE",
      
      "No spell of word or staff will save thee if you have the misfortune to run afoul the Beast of CAERBANNOG",
      
      "The potion of invisibility can render one as a ghost, unseen to all but thy vile demons ~~INVISIBILITY", "Invisibility can give one a safe escape, or secured thievery ~~INVISIBILITY",  "Our mage SHOPPE will sell this powerful potion on a particular odd day ~~INVISIBILITY",
      "Thy staff's Lightning command will summon a great bolt from a storm, striking at range ~~LIGHTNING", "Lightning requires more manna to cast than fireball, but can strike at more damage ~~LIGHTNING", "Casting thy bolt with fully charged manna yields the most power, damaging those close to thy target ~~LIGHTNING", "Train thy mind to make a fully charged lightning blast deal more damage to thy foes  ~~LIGHTNING", "Thou must be under the open sky to bring down a bolt of lightning upon thy foes  ~~LIGHTNING",
      "The staff's fearsome Deathtouch requires close proximity, but will pull the very life from its victim ~~DEATHTOUCH", "The Deathtouch spell requires a wielder with the strongest of manna ~~DEATHTOUCH",
      "Summon a wall of protective flame with thy Fireshield spell ~~FIRESHIELD", "Fireshield is to only be used defensively to stop an advancing enemy ~~FIRESHIELD", "Dare not invoke the Fireshield in a CITY or VILLAGE, lest you destroy the homes of innocents ~~FIRESHIELD", "Mages will only teach Fireshield on a sunny and odd day ~~FIRESHIELD",
      "Bring a statue to life as an ally in battle with Animate-stone ~~ANIMATESTONE", "The casters manna will guide the sturdiness of thy statue borne minion ~~ANIMATESTONE", "Animate-stone has an opposite spell, the dreaded Stonecast ~~ANIMATESTONE", "Our shoppe mages might teach Animate-stone on the 7th day if sunny ~~ANIMATESTONE",
      ...
      "The Tempest incantation will summon a storm, as great as thy MIND ~~TEMPEST", "A storm summoned by thy Tempest spell can extinguish a crackling wall of flame ~~TEMPEST", "Tempest incantations can give thee advantage over beasts that dislike the rain ~~TEMPEST", "The distractions of the storm can make shadowy acts easier for a thief ~~TEMPEST", "A Tempest incantation can only be versed where thy hands can reach towards a visible sky ~~TEMPEST", "The SHOPPE mages will not teach the Tempest spell ~~TEMPEST", "To learn Tempest, one must set camp to meditate with thy staff upon a hill and under a curtain of rain ~~TEMPEST", "Demonstrating a communion with the skies will earn the respect of an Air ELEMENTAL, halting its pursuit of thee ~~TEMPEST",
   ...
   public static String[] horseInfo = {"Wild horses move with great speed, even when mounted", 
                           ...
                           "The UNICORN is the most beautiful creature of these lands and among the most powerful",
                           ...
                           "Our mages celebrate the magic of the RAINBOW, the Unicorn appears from its light",
                           "The UNICORN can only be tamed by feeding it flowers",
                           "A Floretbox must be in hand to get close to the magical beast",
                           "UNICORN patience is fleeting - keep it happy for the short time thee has",
                           "The UNICORN possess much strength and agility, far above that of regular horses",
   ...
   public static String [] dogInfo = {"A dog must be aligned with thy reputation to trust thee",
                           ...
                           "The 'treat' command can earn a dog's trust by sharing", 
                           "The 'stay' command will set thy dog to stillness", 
                           "The 'go' command will send thy dog away, breaking thy bond", 
                           "The 'come' command will have thy dog follow thee",
                           "The 'attack' command will send thy dog to distract an enemy",
                           ...
                           "These WOLFEN and Bear will leave thee be with a dog at thy side",
   ...
   public static String [] werewolfInfo = {"Those with the Wolfen curse will be cast as beast if thee steps into moonlight",
                           "The Wolfen curse will weigh on thee with great heft",
                           "Fear thy Wolfen when night falls, but pity those with the curse when the sun shines",
                           "A Wolfen curse will forbid the planting of a home, once the locals find out",
                           ...
                           "Some semblance of control can be gained over time",
      							...
      							"A silver forged WEAPON will smite a Wolfen cursed soul",     							
   ...
   public static String [] mappingInfo = {"Check thy map before travel, tis not wise to travel without aim",
                           ...
                           "The men of the CITY will mark thy surroundings for five coins. The women will fill thy CITY map for the same",
   ...
   public static String [] trappingInfo = {"The Shoppekeep Butcher makes a fine trap for catching game, perhaps for sale",
                           ...
                           "These massive beasts, like the TROLL and colossus, will destroy the trap when they trod upon it",
   ...
   //information on camping and rest 
   public static  String[] restInfo = {"Sleep will allow thy body to heal properly",
                           "The comfort of thy resting place will affect thy recovery",
                           "The best rest is taken in a soft bed",
                           "One gets better rest by sleeping in the comfort of thy own home",
                           "Having a good dog on guard will let thee sleep more soundly",
                           "A fine dog at thy side in camp will alert thee to approaching dangers",
                           "For camping under the stars, a field of flowers offers the most comfort",
                           "If thee cannot find a field of petals to rest, a patch grass will do",
                           "Camping under the trees will suffice if a field be out of sight",
                           "If rest is needed in a driving rain, seek shelter in the forest",
                           "Taking camp on coarse sand will disrupt thy rest",
                           "Tis quite difficult to get good rest on a rocky hill"
                           };
   ...
   public static String [] swineInfo = {"Swine is a game of wagering gold against the rolled points from a six sided number cube",
                           ...
                           "Beware agreeing to a game of Swine with a grim DEMON. The stakes are high if thee falls short on rolls"
                           };
   ...
   public static String [] gemInfo = {"Thy home is a safe place to rest and upgrade ARMS",
                           ...
                           "The reddened Ruby is the hue of MIGHT, and will strengthen the warrior that carries ruby ladened ARMS",
...
//only elements that contain "~~" should be added in the journal
   public static String[] shopInfo = {
                           ...
                           "The injured and sickened can find CURE for coin or PANGOLIN scales at the Mage's Shoppe ~~MAGIC",
   ...
   public static String[] locationInfo = {
      ...
      "Various armies march across the plain, seeking resources, vengeance or chaos ~~BATTLEFIELD", 
      "Local militias are summoned to defend the villages from BEAST armies, and a brave adventurer can find some work there ~~BATTLEFIELD", 
      "Some battles linger in the rubble of villages overrun by hostile forces, some in fields outside the gates of vulerable towns ~~BATTLEFIELD", 
      "If thee has a dog companion, set them on stay at the border. Tis cruel to have them fight. ~~BATTLEFIELD", 
      "Good experience is to be gained on the battlefield, even by merely witnessing the strategies employed there ~~BATTLEFIELD", 
      "Some city elders might pay thee to see to the safety of kin who wish to witness a battle ~~BATTLEFIELD", 
      "On the battlefield, the ARMS of the fallen can provide a small wealth of gold when traded ~~BATTLEFIELD",
      
      "Regiments Guards and Brigands will set up encampments when traveling the lands of Cultima ~~CAMP", 
      "The city Guards are sent out to trap the beasts that ravage livestock, and their catch will be held in fire-lit camps ~~CAMP", 
      "Guard camps are used to trap those stricken with the Wolfen curse to ease the threat from their carnivorous lunar activities ~~CAMP", 
      "The dreadful Brigand regiments will ensnare forest beasts, aiming to train them to join their terrible armies ~~CAMP", 
      "Tread carefully around these soldier camps, for the guards are well armed and their catch is eager to escape from their traps ~~CAMP",
      ...
      "The winter BEAR will hibernate in caves, and their pelt can protect thee from the biting cold ~~CAVE",
      ...
      "Those that seek solace and quiet might set up SHOPPE away from the CITY and VILLAGE ~~HUT", 
      "One can find a safe place to camp in remote hovels, and possibly RATIONS or mage's supplies ~~HUT", 
      "The HERMIT that communes with nature has special abilities - an AWARENESS not unlike that of the beast of the wood ~~HUT",
      
      "Bring a HAMMER to the mines of Cultima, and riches await the adventurer thick with muscle ~~MINE", 
      "Active mines glow with torchlight in spots, but their damp and dark corridors can become home to BEAST ~~MINE", 
      "Dare not HAMMER a wooden support, lest ye tempt a mine collapse ~~MINE", 
      "Some mines have been abandoned for being unstable, the very ceiling ready to come down upon thee ~~MINE",
      
      "Within the mountains rest the sanctuary of beast-like men, and men that act as BEAST ~~LAIR", 
      "TROLL, GOBLIN and BRIGAND can be found in their mountain lairs ~~LAIR", 
      "Within mountain lairs, the cries of villagers carried away can be heard from dark prisons ~~LAIR", 
      "The lair floors are set with traps, but the treasures stolen from the towns can be found within ~~LAIR",
      
      "The commerce of the seas meet at the Port, a large CITY with muddy streets, taverns and SHOPPES ~~PORT", 
      "In a Port CITY, some shopkeeps can sell thee a SHIP for sailing the waterways of Cultima ~~PORT", 
      "Keep on guard in the Port Towns: thieves roam the streets ~~PORT", 
      "Beyond the Port's piers, tis known that BRIGAND ships and beastly creatures of the deep can strike at thee ~~PORT",
      
      "The most advanced cities of Cultima might have a sewer system to carry away waste ~~SEWER", 
      "The sewers are a marvel of engineering, but can harbor dangers and disease ~~SEWER", 
      "Fledgling adventurers might test their skills against the rats and spiders of the sewer ~~SEWER", 
      "Rare but dangerous foes can lurk in the sewer, quickly ending a young adventurer's training  ~~SEWER", 
      "Treasure from fallen adventurers can be found for those that dare test the smells and dangers of the sewer ~~SEWER", 
      "If gaining experience in the sewer, take care to avoid solid waste, which can make thee sick and seeking a poisons cure ~~SEWER", 
      "The guards might tell thee more about the dangers of the sewer, as some are hired to free a clog from time to time ~~SEWER", 
      "Some sewers connect to grand underground rivers, used by the axe trade to transport their lumber ~~SEWER", 
      "Sewers that connect to underground log flumes make for local folly as residents compete to cross the moving lumber ~~SEWER",
      
      "Some temples are in ruins, still reaching up to ancient gods, and some still active with the worshippers of SKARA Brae ~~TEMPLE", 
      "The Temples of Cultima offer mystery, solace or danger ~~TEMPLE", 
      "Years past of sacrifices to old gods will draw SORCERER, SPECTRE and DEMON to some Temples ~~TEMPLE", 
      "Some Temple statues hide the entrance to a torch-lit DUNGEON, laden with traps and beasts ~~TEMPLE", 
      "Many temples offer a sanctuary of reflection, a bed of flowers to rest, and wise Mages to teach thee ~~TEMPLE",
      ...
      "Yes, the Underworld is a mysterious place, filled with fire and fear ~~UNDERWORLD", 
      "Rare portals to the Underworld shimmer in the bowels of odd caves ~~UNDERWORLD", 
      "The pulsating doors to the Underworld are unstable, and thee might get thrown chaotically through time ~~UNDERWORLD", 
      "Lakes of magma and rain of ash fall upon the denizens of the Underworld - DEMON, phantom, and deadite ~~UNDERWORLD",
      "Beware the Magma-mothers who rise from molten rock to command fire and suffering ~~UNDERWORLD", 
      "Waste not arms on Magma-mothers, lest they cast frost and ice ~~UNDERWORLD", 
      "The Underworld is the home of Lady DEATH, who whispers in thy mind as she stalks thee ~~UNDERWORLD", 
      "Look for an oasis of water and wells in the Underworld, but beware the puzzle that awaits thee there ~~UNDERWORLD", 
      "The jagged stone ledges over the magma rivers might break with the strike of heavy arms ~~UNDERWORLD", 
      "The brittle Underworld ledges could serve as a makeshift raft across the magma rivers ~~UNDERWORLD",  
      "Look for any means of escape from the Underworld, be it a portal or a tear in the edge of reality ~~UNDERWORLD"
   };
   ...
   public static String [] wellsPuzzleInfo = {
                           ...
                           "The challenger will drink from the Puzzle Giver's Goblet, thy Puzzle Giver drinks from thy challenger's Goblet",
  ...
  //returns a weighted random water monster type for attacking port cities
   ...
   public static byte randomSlayMissionMonster()
   {
      ...
      byte [] worldMonstersNight = {BUGBEAR, BUGBEAR,BUGBEAR,BUGBEAR,BUGBEAR,BUGBEAR,
                               ...
                               TROLL, TROLL,TROLL,TROLL,TROLL,TROLL,
                               WEREWOLF};
      byte [] kingMonsters = {WOLFKING, BEARKING, DEMONKING, SNAKEKING, RATKING, SPIDERKING, BUGBEARKING, TROLLKING, DRAGONKING, BEAROWL, LANDSHARK};
      if(Math.random() < 0.2)
   ...
   public static byte randomSlayMissionMonsterRaining()
   {
      byte [] worldMonsters = {BUGBEAR, BUGBEAR,BUGBEAR,BUGBEAR,BUGBEAR,BUGBEAR,
                               ...
                               TROLL, TROLL,TROLL,TROLL,TROLL,TROLL,
                               BRIGAND_SWORD, BRIGAND_SPEAR, BRIGAND_HAMMER, BRIGAND_DAGGER, BRIGAND_CROSSBOW, BRIGANDRIDER, BRIGAND_FIST};
      byte [] kingMonsters = {WOLFKING, BEARKING, SNAKEKING, RATKING, SPIDERKING, BUGBEARKING, TROLLKING, BEAROWL, LANDSHARK};
      if(Math.random() < 0.8)
         return Utilities.getRandomFrom(worldMonsters);
      return Utilities.getRandomFrom(kingMonsters);
   }
   ...
   public static byte randomTempleMonster()
   {
      ...
      byte [] templeMonstersWinter = {GHOST, GHOST,GHOST,GHOST,GHOST,GHOST,
                                ...
                                MINDDEVOURER,MINDDEVOURER,
                                PANGOLIN, PANGOLIN};
      //TESTING:if(true) return SORCERER;
      if(Display.isWinter())
   ...
   {
      byte [] underworldMonsters = {GHOST, SKELETON, PHANTOM, DEMON, MAGMA, FIRE, FIRE, MINDDEVOURER};
   ...
   {
      byte [] underworldMonsters = {GHOST, SKELETON, PHANTOM, DEMON, MINDDEVOURER};
      return Utilities.getRandomFrom(underworldMonsters);
   }
   ...
   {
      byte [] caveMonsters = {BUGBEAR, CYCLOPS, DRAGON, GIANT, ORC, NIGHTORC,TREE, TROLL, BAT, RAT, SNAKE, SPIDER, BEAR, RUSTCREATURE, SLIME, MINDDEVOURER};
      byte [] caveMonstersNonWinter = {BUGBEAR, CYCLOPS, DRAGON, GIANT, ORC, NIGHTORC,TREE, TROLL, BAT, RAT, SNAKE, SPIDER, RUSTCREATURE, SLIME, MINDDEVOURER};
   ...
   public static byte randomLairMonster()
   {
      byte [] lairMonsters =   {ORC, ORC,ORC,ORC,ORC,ORC,ORC, ORC,ORC,ORC,ORC,ORC,
                               ...
                               GOBLINBARREL, GOBLINBARREL,
                               MALEVAMP, FEMALEVAMP,
                               MINDDEVOURER,MINDDEVOURER,MINDDEVOURER,MINDDEVOURER};
   ...
   public static byte randomDungeonMonster()
   {
      byte [] dungeonMonsters = {RUSTCREATURE,RUSTCREATURE,
                                 ...
                                 BRIGAND_SWORD, BRIGAND_SPEAR, BRIGAND_HAMMER, BRIGAND_DAGGER, BRIGAND_CROSSBOW, BRIGAND_FIST, 
                                 SORCERER,SORCERER,SORCERER,SORCERER,SORCERER,SORCERER,
                                 MALEVAMP, FEMALEVAMP, LICHE, BEHOLDER, GORGON};
      //TESTING: if(true) return GORGON;
...
//returns a random guard type
   ...
   public static byte randomTreasureGuard()
   {
      ...
      //returns a random guard type
   public static byte randomCityGuard()
   {
      byte [] guards = {GUARD_SPEAR, GUARD_SWORD, GUARD_FIST};
      return Utilities.getRandomFrom(guards);
   }
   ...
   {
      byte [] monsterKings = {BEAROWL, LANDSHARK, DEMONKING, DRAGONKING, TREEKING, BATKING, RATKING, SNAKEKING, SPIDERKING, WOLFKING, BEARKING, BUGBEARKING, TROLLKING, DEATH, EARTHELEMENTAL};
      return Utilities.getRandomFrom(monsterKings);
   }
   
   //return a boss monster for the castle dungeon slay mission
   public static byte randomDungeonMonsterKing()
   {
      byte [] monsterKings = {DEMONKING, DRAGONKING, SNAKEKING, SPIDERKING, BUGBEARKING, TROLLKING, LICHE, BEHOLDER, GORGON};
      return Utilities.getRandomFrom(monsterKings);
   }
   ...
   {
      byte [] monsterKings = {TROGDOR,EARTHELEMENTAL,TORNADO, LANDSHARK};
      return Utilities.getRandomFrom(monsterKings);
   }
   ...
   {
      byte [] monsterKings = {BEAROWL, LANDSHARK,GORGON, BEHOLDER, LICHE, DEMONKING, DRAGONKING, TREEKING, BATKING, RATKING, SNAKEKING, SPIDERKING, WOLFKING, BEARKING, BUGBEARKING, TROLLKING};
      return Utilities.getRandomFrom(monsterKings);
   }
  ...
  //given a monster type, returns the king/boss version
   public static byte getMonsterKing(byte monster)
   {
      ...
      if(monster==SQUID)
         return SQUIDKING;   
      if(monster==GRABOID || monster==RUSTCREATURE)
         return LANDSHARK;
...
//returns a random element from a list of Strings
   ...
   public static String talk(NPCPlayer selected, String typed)
   {
      ...
      if((typed.contains("slap") || typed.contains("hug")) && !isBlackKnight(selected.getCharIndex()) )
      {
         ...
         {
            Sound.slap();
            CultimaPanel.player.setReputation(selected.getReputation()-1);
      ...
      { 
         ...
         if (caught || selected.getCharIndex()==DEMONKING || selected.getCharIndex()==DEMON || isGarriott)
         {
            ...
            if(selected.getCharIndex()==DEMONKING || selected.getCharIndex()==DEMON)
            {
               ...
               CultimaPanel.sendMessage("The glove burns off thy hand!");
            }
      ...
      if(selected.getMoveType()==NPC.CHASE && selected.getCharIndex()!=NPC.TAXMAN && !selected.isEscortedNpc() && !(selected.getNumInfo()==10 && typed.contains("mission")))     //bribe is the only option if someone is chasing you
      {
      ...
      if(allignmentCompatable(selected) || charmed || (Math.abs(allignmentDifference(selected))) < (Math.random()*100) || selected.getCharIndex()==TAXMAN)
      {
         ...
         if(TerrainBuilder.habitablePlace(selectedLoc) && CultimaPanel.isNight && monsterType!=-1 && Math.random() < 0.5)
         {
      ...
      //buy an item from the NPC
         ...
         else if(selected.hasEffect("poison") && (typed.contains("cure") || typed.contains("potion")) && (CultimaPanel.player.hasItem("cure") || CultimaPanel.player.knowsSpell("cure")))
         { 
            selected.removeEffect("poison");
            if(CultimaPanel.player.knowsSpell("cure"))
            {
               CultimaPanel.player.castSpell("Cure");
               Spell curr = Spell.getCure();
               CultimaPanel.player.setManna(CultimaPanel.player.getManna() - curr.getMannaCost());
            }
            else if(CultimaPanel.player.hasItem("cure"))
            {
               CultimaPanel.player.discardPotion("Cure");
            }
         ...
         else if((selected.getLocationType().toLowerCase().contains("village") && CultimaPanel.numNPCsInLoc==1) || selected.getLocationType().toLowerCase().contains("domicile"))
   ...
   {  //general responses before the unknown response
      ...
      String[] monsterGeneral = {"The local adventureres can tell you more of beasts", "Advernurers know all about the beasts", "Seek those with swords to tell you of beasts", "Tis the swordsmen that know about monsters", "Our local adventurer is penning a manual on that very subject - a monster manual", "Have you seen that man who wields a sword? He will know much more on the subject"};
      String[] lairGeneral = {"The local swordsmen know of the location of monster lairs", "The adventurers in town know where the lairs are", "Ask those with swords - they have been to the monster lairs", "Tis the swordsmen that have the information you seek", "The lairs of villainous beasts are only known by adventurers and those that have been stolen away"};
      ...
      String[] townGeneral = {"Our good barkeep knows of everyone in town", "The townsfolk are known by the barkeep", "If you want to know of the townsfolk, ask the barkeep", "Our pub has a barkeep who knows everyone in town", "Gossip and ale are the trade of the barkeep", "Ask the barkeep of the townsfolk. Plenty of gossip there", "Find the sign with the goblet - speak with the barkeep"};
      String[] tradeGeneral = {"Seek thee a shoppekeep to trade", "I am not a shoppekeep", "I have nothing to trade: find thee a shoppekeep", "Perhaps you are looking for a shoppe of some kind", "The shoppes have telling signs: armory, spellcraft, rations and ale", "I can sell you no wares but an idea and a dream. Look for the shoppes with sign", "Our CAPITAL has the most shoppes for wares"};
      String[] cureGeneral = {"Seek thee a mage's SHOPPE to get a cure for thy poison", "The mage's SHOPPE offers cures and HEALING", "Look for the sign with the blue flask for cures and HEALING", "Seek thee a mage's SHOPPE for curing and HEALING", "Poison can be drawn from the blood by spell or potion", "If thee does not practice spellcraft, seek thee the potion from the magic shoppe"};
      String[] curseGeneral = {"Seek thee a lute player", "Our lute player knows music that can cast out thy curse", "Look for the man with the lute: his song can cast out a curse", "Seek thee a lute player and request a song", "A curse can haunt thee for ages, but music can draw it out", "Our lute wielding songsmith knows a tune that can pull the curse from thy very soul"};
      ...
      String[] mapGeneral = {"Those from other lands might mark their HOME on your map when asked", "The general citizens can aquaint you with thy map's unknown regions for a price", "Our Butcher at the Rations SHOPPE knows much about mapping", "I am not skilled at mapping, but others might help. Ask the Butcher in the Rations SHOPPE", "For a small fee, some in town can point out the places they know on thy map", "A map has lakes with no water, no travelers but with street"};
      String[] rationGeneral = {"Our local butcher sells rations.", "Some get thy rations from hunting game.", "A DOG makes for a fine companion when hunting game for rations.", "Our baker sells five days ration for one gold coin: tis a bargain", "There are three ways to a full belly: thy coin, thy bow or shameless thievery", "Rations can sometimes be found in barrels if eyes are not upon you"};
      ...
      String[] weatherGeneral = {"The weather? Ask the wiseman", "The mages are fine at predicting the weather", "The weather's prediction is best made by the mages", "Try the wiseman - thy mages know the weather's FUTURE", "Mind the weather and WIND before travel - the wise with staff knows", "Spring and Autumn bring higher chances of fog, making travel and combat difficult", "Mind the coming of Winter's cold and have beast FUR to protect thee", "Thy torch will not work in a driving rain - mind the weather before travel", "Thieves take advantage of the blanket of fog and distraction of storm to work their CRAFT", "Tis the weather - rain, fog, snow and WIND", "The wisest travelers keep mind of the weather and WIND", "Mind the wind! Tis a vortex with a spirit that will chase thee - the Air ELEMENTAL"};
      String[] windInfo = {"Tis wise to understand the wind of the lands", "Strong winds will carry flame to new fuel", "Sailing depends on the winds for travel - thy speed depends on it", "Mind thy winds when HUNTING - thy game can smell thee", "Tis known, stay upwind on the HUNT of thy target", "Creatures of the plain can smell thee better if downwind", "The mages can easily control the winds with a SPELL", "I have seen a wooden talisman, tis said to control the winds and WEATHER", "I have seen a wind with a spirit within! A spinning vortex that chased me! Tis an Air ELEMENTAL", "My kin has seen walking across the plain, a massive Elemental of Earth", "The wind be voiceless but cries, wingless but flutters, tootless but bites, mouthless but mutters"};
      String[] rainGeneral = {"Tis said that some mages can make it rain by commanding the skies", "The towns that settle crops needeth a good mage that knows thy TEMPEST spell", "We could do with a good rain", "The spellcasters know of an incantation that can command the very skies to cast rain", "I am only happy when it rains...", "If thee needs to block the very sun, learn the Tempest SPELL", "The mages can easily control the rain and clouds with a SPELL", "I have seen a wooden talisman, tis said to control the very rain and WIND", "Those of high mind might study with mages to learn to cast the sky to rain", "I have seen it with thy own eyes, a mage that brought rain to crops when needed"};
      String[] flowerGeneral = {"Many beautiful florets blossom from the soil of CULTIMA", "I have seen mages pick the florets of these lands, but for what purpose...", "Florets are important for the mages, who collect and carry them in a Floretbox", "The Floretbox is a rare find, not always available in the shops I hear", "Have you heard of thy mystical horned horse, tis said to be drawn to florets", "If thee needeth a collection of florets, seek out a Floretbox from the mages shoppe", "Our florets are quite glorious, are they not?..."};
      String[] cityAsk = {"Have you been to our grand CAPITAL before?", "Our greatest city is our very CAPITAL", "Our CAPITAL is the most grand city", "The largest of cities in the land is our very CAPITAL"};  
      ...
      String[] werewolfGeneral = {"The woman of the temple has knowledge of WOLFEN", "Did thou say WOLFEN? Ask thy woman of the temple", "The woman of the temple has experience with WOLFEN", "Were-wolf?  There-wolf."};
      ...
      String[] isWerewolfPurge = {"We did not chose thy WOLFEN curse. We just want to be left be", "We WOLFEN cursed have outcast ourselves as to not threaten others. Let us be in peace", "We deserve to be left in peace. Our WOLFEN curse was not asked for", "Our cuse is a heavy burden. We live far from others as to not be a threat"};
      ...
      String[] rollPassGeneral = {"Rolling and passing are moves for the game we call SWINE", "To pass and roll are done in games of SWINE", "One can pass and roll in a good game of SWINE", "Tis the game SWINE where one might roll or pass"}; 
      String[] deathGeneral = {"Say not her name, lest she comes for thee", "Still thy tongue! Invoke not her name, lest ye invite her visit", "Say not her name aloud! If she comes for thee, run", "Her name spoken is an invitation! Speak it only in whispers", "The sworded adventurers speaks of her in whispers", "Tis said she will not haunt these lands on our holy HOLIDAY"};
      ...
      String[] commonChallenge = {"Such language! This conversation has ended!", "I will not hear such filth! Speak to thy dust as I exit this conversation!", "Watch thy tongue! I am leaving!", "These words are not befitting my presence! Thee is out!", "You mocked me once, never do it again!"};
      String[] rainbowGeneral = {"Tis glorious to see the colors when the rainfall ends", "I hear that magics are more potent when one casts it under a rainbow", "Dost thou know my cousin, Roy G Biv?", "The mages spells come at less of a cost when the colors arch across the sky", "The wise ones and mages know more of rainbows and WEATHER", "Seek the wise ones with staff to learn more of WEATHER and rainbows", "If one is lucky enough, thee might see the UNICORN when the rainbow is above", "I love thy rainbows as much as the fabled UNICORN", "Tis all rainbows and UNICORNS"};
      String[] unicornGeneral = {"The horned horse? I think they are only of legend", "Legend says the Unicorn uses the RAINBOW as a path to this realm", "The Royal Guard of the CAPITAL speaks of Unicorns", "Our Capital's Royal Guard knows more of this colorful myth"};
      String[] craftingGeneral = {"Seek the CASTLE Ironsmith. They know of crafting arms", "The city Ironsmith is skilled enough to craft armor from the scales of beasts", "The Ironsmith of the CASTLE is known to craft weapons", "For those mighty enough to slay scaled beasts, the city Ironsmith can craft the scales to ARMOR", "Knowledge of arms and gems rests in the mind of the CASTLE Ironsmith", "Tis known the Ironsmith of the city has crafted armor from the scales of great beasts", "In the CASTLE is the finest of crafters: the Ironsmith", "Beast scales are a rare find. The city Ironsmith aims to craft them into the finest armor"};
      String[] taxGeneral = {"Thy taxes are so high these days, tis a burden", "The TAXMAN does take a bite out of thy wages, doesn't he", "Declare the gold coins on thy eyes... TAXMAN!", "Be thankful thy TAXMAN doth not take it all", "Thy home and gold on hand can be taxed now! Sneak past when thy TAXMAN is about", "I hope a clever mage can frighten the TAXMAN out of town with a Fear spell", "Note which way thy TAXMAN is walking. If he sees thee, he will come for thee", "A loyal dog at thy side might intimidate a tax collector of low valor", "Even the Taxman takes a day off on our HOLIDAY"};
      String[] futureGeneralGood = {"Ask the old mages about thy future. I can not see it", "Tis easy. The TAXMAN is in your future. Tis so for all of us", "I know not...from the fierce looks of thee, possibly fighting a beast or two...", "A mage can tell thee of thy near futures, but far off tis more difficult"};
      String[] futureGeneralBad = {"Ask the old mages about thy future. I can not see it", "Tis easy. The TAXMAN is in your future. Tis so for all of us", "I know not...from the scruffy looks of thee, possibly getting sullied in the tavern...", "A mage can tell thee of thy near futures, but far off tis more difficult"};
      ...
      String[] agilityInfo = {"To TRAIN in agility will help thee run from superior foes", "The most agile of adventurers often carry a BOW, SPEAR, STAFF or DAGGER",
                                        ...
                                        "The CASTLE jesters are the most agile in the land, and may train thee for coin or PANGOLIN scale"};                                 
      ...
      String[] hermitInfo = {"The Hermit has rejected us, and embraced nature", "In a lone thatch hovel lives thy Hermit", "Tis said that a life of solitude has mastered thy Hermit's AWARENESS", "The Hermit may train thee in AWARNESS, but tis said will require a sacrifice",
                             "Roam these lands and you may find the lone hovel of the Hermit", "The Hermit lives in solitude, but has a SHOPPE for weary travelers", "Tis known that thy Hermit has helped those striken by beastly curses"};                                    
      ...
      String[] fireInfo = {"Keep thy TORCH and flamed weapons away from buildings -not all are brick", "Wooden doors are prone to flame. Keep it clear of my hovel", "A nice TORCH can light thy way, and warm thee when snow falls", "Tis said that BEAST of frost will wilt to flame", "The most powerful mages can summon fire and cast it upon thee", "Unruly flames can be snuffed by the magic frost from enchanted weapons", "I saw the hilt of a flamed axe once, within a red GEM", "Have you seen the fire that moves as if alive? Tis a feared ELEMENTAL", "Fire will crack and snap, yet stay whole. Against wooden things it takes the greatest toll.", "Fire has many tongues, but can not taste. By it, most things are turned to waste."};
      String[] coldInfo = {"The winters here bring a mighty chill", "The hide of ELK, WOLF or BEAR can keep the cold at bay", "Tis known that ARMOR of the sea-dragon scales can protect thee from cold", "If thou travels in winter storms, tis best to don furs and travel with TORCH", "The midwinter cold will cast our lake solid - it makes travel easier", "I have seen a GEM that cast a powerfull chill", "A skilled mage can cast a MAGIC frost to freeze thy foes"};
      String[] peltInfo = {"With a weapon of range, one can safely fell an ELK for its pelt", "The BEAR has the most valuable pelt, but tis a mighty foe to fell", "Tis more dangerous to seek a WOLF pelt, but provides better protection than ELK", "Hunting for pelts - tis an art in itself", "One must know to read the WIND to hunt for pelts", "Fleeting game can smell thee if seeking pelts - mind the WIND", "Pelts give protection from COLD, or gold when sold", "A trained DOG makes a fine companion when hunting for pelts"};
      ...
      String[] hauntedGeneral = {"The gray house makes me nervous. Tis something wrong with that place.", "Tis haunted! Terrible deeds have occured in that grey house!", "The grey house is a cursed place, full of pain, hate and sorrow!", "I do not go near that grey house - tis a wretched place!", "Tread not near the maw of that grey house lest thee be one of valor!", "Anguished moans have I heard when passing that grey house. Tis haunted!", "Whispered tales of torment and sorrow have been sung about that grey house for generations!", "The very sight of that grey house makes thy skin feel as if fridged spiders run about it!", "The phantoms slink about in that grey house. Beware!", "Dare not sleep in nor camp near that gray house, lest thee be awaken by a phantom or worse!"};
      String[] hellmouthGeneral = {"Ask the spellcasters of the Hellmouth. I know little of interdimensonal portals to parallel realms of known realities in spacetime", "I have only heard of these Hellmouths from the mysitic spellcasters. Ask them", "I am not wise in the ways of the mystic realms. Ask thy mages about this", "Tis a mystery to me, these Hellmouths. The mages will know of them", "Hellmouths? Sounds terrifying! Perhaps the mages know of them", "Our mages know of these mystical constructs. I know of SWINE, the tavern and simple things", "Yes, Hellmouths are quite vexing. Seek thy spellcasters to tell thee more"};
      ...
      String[] bridgeGeneral = {"Thee needs good LUMBER to build a bridge", "LUMBER bridges make for easy crossing of water, or use planks to cover a muddy patch in a town street", "Those with bridge building skills can also erect LUMBER piers for port towns", "Thee needs a good AXE in hand to harvest materials to build a nice bridge", "If not reachable by boat nor ship, build a bridge I say", "As they say, tis water under the bridge", "A useful skill to fashion LUMBER to a bridge over troubled water", "A bridge, you say? Tis the best part of the song!", "They say to build bridges, not walls. But what will hold up the roof, I ask thee?", "Our bridge can cross rivers and streams, but do not move."};
      ...
      String[] assassinGeneral = {"There are three assassins of the Brigand-King, all earn extra coin by collecting bounties", "The three assassins are ruthless, and leave no witnesses to their reaping", "The dark of night is when the assassins prowl, so beware city streets after sundown", "The Bow-Assassin is an expert markswoman, and often utilizes bows of special qualities", "The She-Assassin is stealthy, and wields poison daggers in the dark of night", "Poison-bolts from a crossbow is the tool of choice for the Dark-Enforcer, the third of the three assassins", "Even the assassins take a day off to celebrate SKARA Brae Day", "Thankfully you will not meet an assassin on our holy HOLIDAY"};
      ...
      String[] trogdorGeneral = {"The Dragon Queen has her king, 'tis Trogdor the Burninator!", "And the Trogdor comes in the night!", "When all the land is in ruins, and burnination has forsaken the countryside...", "No thatch-roof cottage is safe from Trogdor the Burninator!", "There is no defeating Trogdor, only fleeing!", "You should see him in all his magesty!", "Pointy spikes, pointy scales and pointy teeth, all consummate v's"};
      String[] underworldGeneral = {"The mages of the CASTLE know more of this Underworld.", "Some know of this Underworld, the mages be found in the CASTLE.", "Seek an audience with the CASTLE mages. They know well this Underworld.", "Tis the CASTLE mage you seek for knowledge of this Underworld."};
      String[] bruteSquadGeneral = {"Brute Squads are assembled to protect our towns from regiments of BEASTS", "Decent pay can be gained for dangerous work on the Brute Squad", "Brute Squads are captained by guards, local adventurers, and sometimes bounty hunters", "Brigands will raise armies of BEASTS to assault towns, and the Brute Squads are there to answer them"};
      ...
      else if(typed.contains("underworld"))
      {
         response =  getRandomFrom(underworldGeneral);
      }
      ...
      else if(typed.contains("rest"))
      {
         response =  getRandomFrom(restInfo);
      }
      ...
      else if(typed.contains("town") || typed.contains("person") || typed.contains("people") || typed.contains("info") || typed.contains("help") || !townWord.equals("?"))
      {
         if(!townWord.equals("?"))
         {
            String [] littleInfo = {"I only know a little of this ", "There are those that know much more than I about thy ", "The barkeep can tell thee more about this ", "I have only heard from others information about thy "};
            if(Math.random() < 0.25)
      ...
      else if(typed.contains("arms") || typed.contains("weapon") || !weaponWord.equals("?"))
      {
         ...
         { 
            String [] littleInfo = {"I only know a little of this ", "There are those that know much more than I about thy ", "Our ironsmith can tell thee more about this ", "I have only heard from others information about thy "};
            if(Math.random() < 0.25)
      ...
      {
         String [] littleInfo = {"I only know a little of this ", "There are those that know much more than I about thy ", "The sword wielding adventurers can tell thee more about this ", "I have only heard from others information about thy "};
      ...
      else if(typed.contains("trogdor") || typed.contains("burninat"))
      {
         if(Math.random() < 0.1 && System.currentTimeMillis() > CultimaPanel.cheerTime + 5000)
         {
            Sound.trogdor();
         }
         return getRandomFrom(trogdorGeneral);
      }
      ...
      else if(typed.contains("spell") || typed.contains("spells") || typed.contains("magic") || !spellWord.equals("?"))
      {
         ...
         else if(!spellWord.equals("?"))
         {
            ...
            {
               String [] littleInfo = {"I only know a little of this ", "There are those that know much more than I about thy ", "Our mages can tell thee more about this ", "I have only heard from others information about thy "};
               response = getRandomFrom(littleInfo) + typed;
            }
         }
         else
      ...
      {
         String [] answerStart = {"Tis", "Thy favorite color? I like", "Without question, tis", "I have always like shades of", "The greatest color of all, tis", "The color thay catches my eye? Tis various hues of"};
      ...
      else if(typed.contains("brute") || typed.contains("squad"))
      {
         response = getRandomFrom(bruteSquadGeneral);
      }
      else if(typed.contains("r.o.u.s") || typed.contains("rous")) 
      {
  ...
  //return a response when the player is talking with the arena-master
   public static String arenamasterResponse(NPCPlayer selected, String typed)
   {
      ...
      String[] futureGeneral = {"Thy future is before thee, in this very arena!", "Tis easy. Glory in battle before an adoring crowd is in thy future!", "I see from the fierce looks of thee, fighting a beast in thy arena is in thy future", "The mages know little of thy future. I can see that it is here, fighting for glory in my arena!"};
   ...
   public static String guardResponse(NPCPlayer selected, String typed)
   {
      ...
      String[] guardNoBounty = {"The ASSASSIN has heard of thee, but you have not enough enemies to spark their interest", "Your bounty is negligable. The ASSASSIN be not interested in thy head", "Thy bounty is low. You need not worry about the ASSASSIN", "The ASSASSIN would indeed be desperate to seek such a low bounty"};
      ...
      String[] buyEgg = {"The coveted DRAGON egg! Take 150 gold coins in trade!", "I have 150 gold to trade for thy Dragon's egg!", "I need that DRAGON egg! Take 150 gold coins to trade!", "Take these 150 gold coins in trade for that Dragon's egg!"};
      ...
      if(selected.getNumInfo()==10 && !typed.contains("mission") && !selected.isSellingHouse() && Math.random() < 0.33)
      {
      ...
      else if(!selectedLoc.contains("village") && !selectedLoc.contains("domicile") && (typed.contains("lift") || typed.contains("train") || typed.contains("might") || typed.contains("strength")))
      ...
      else if((selectedLoc.contains("village") || selectedLoc.contains("domicile")) && typed.contains(""+amountToTrainGuard(selected)))
      {
         int amount = amountToTrainGuard(selected);
   ...
   public static String beggerResponse(NPCPlayer selected, String typed)
   {
      ...
      if(((typed.contains("coin") || typed.contains("charity") || typed.contains("give") || typed.contains("gold") || typed.contains("pay")) && CultimaPanel.player.getGold() >= 1) || (typed.contains("ration") && CultimaPanel.player.getRations()>=5 && !CultimaPanel.player.isVampire()))
      {
         ...
         else if (!CultimaPanel.player.isVampire())
         {
            for(int i=0; i<5; i++)
               CultimaPanel.player.useRation();
            if(selected.getNumInfo() > 0 && !typed.contains("ration"))
            {  //don't get more than 3 reputation points for giving to a begger
               CultimaPanel.player.addReputation(1);
               selected.setNumInfo(0);
            }   
      ...
      else if(selected.getNumInfo()==10 && !typed.contains("mission") && !selected.isSellingHouse() && Math.random() < 0.33)
      {
         if(selected.getMissionInfo()!=null && !selected.getMissionInfo().equals("none") && FileManager.wordIsInt(typed))
         {
            Mission currMission = null;
   ...
   public static String luteResponse(NPCPlayer selected, String typed)
   {
      ...
      String[] luteCurse = {"That song is difficult: 'twill require 60 coins", "I will play that song for 60 gold", "60 coins or PANGOLIN scales are all I ask to play that song", "You want the best, you got the best: 60 gold, please"};
      ...
      String[] lutePay = {"My sweet music has lifted your curse!", "The demons have left you", "This the sound of the song that lifts thy curse", "Tis the music that purges your demons"};
   ...
   public static String wiseResponse(NPCPlayer selected, String typed)
   {
      ...
      String[] numberResponseYes = {"Tis 50 by 50 at 50", "I see three of 50: 50 by 50 at 50", "The number you seek is 50: 50 by 50 at 50", "Tis there - 50 by 50 at 50", "See what I point towards: 50 by 50 at 50"};
      ...
      String[] caves = {"The HERMIT knows of the mysterious green caves", "Seek the HERMIT and ask of the green caves", "Knowledge of the moss caves is known by thy HERMIT", "The strange magic of the moss caves is known to the HERMIT", "Beware thy journeys, lest thee stumble across the Cave of CAERBANNOG", "The HERMIT knows of these caves, but beware of what you seek lest it end you at CAERBANNOG"};
      ...
      String[] elementalInfo = {"The living spirits have been seen in three of the four elements: Earth, Wind and Fire", "If an elemental chases thee, seek cover and hide! The tall grass or shallow water might slow its pursuit", "A spinning vortex of wind can topple trees and houses, even worse when directed by the spirit of the Wind Elemental", "WIND Elementals will chase thee, unless you gain their respect by showing a command of weather", "Learn the Shiftwind and TEMPEST spells to earn thy escape from Wind Elementals", "FIRE Elementals are the most feared, unleashed by Grim Demons and the Mothers of Magma", "If chased by Fire Elementals in the plains of CULTIMA, look for water and dive in with no pause", "Fire Elementals can be wilted by weapons and magic of frost, or the raging rain of a Tempest SPELL", "Send not arrows into a Fire Elemental: Tis more fuel for the BEAST to grow", "The massive Elemental of Earth can trap thee with raised stone", "Casting a spell that shows command of the earth and stone can earn the respect of an Earth Elemental", "Learn thee Raise-stone or Raise-earth to end the pursuit of the dreaded Earth Elemental"};
      ...
      String[] underworldMageGeneral = {"The mages of the CASTLE know more of this Underworld.", "My brothers know of this Underworld. They can be found in the CASTLE.", "Seek an audience with the CASTLE mages. They know well this Underworld.", "Tis the CASTLE mage you seek for knowledge of this Underworld."};
      String[] pangolinInfo = {"The Gold-Pangolins are no ordinary creatures, but the pets of Skara Brae herself!", "Tis said that SKARA Brae's pets had a litter too large for her realm, thus the Gold-Pangolins were cast into Cultima.", "Gold-Pangolins are trapped by greedy Lords and must be rescued from the hands of man!", "If the last Gold-Pangolin is siezed by greed, Cultima will fall into corruption and ruin!", "The sacred Gold-Pangolins must be allowed to roam the wilds for the lands Cultima to remain in balance.", "Seek thee a Floretbox to collect flowers so that they can be offered to our sacred Gold-Pangolins."};
      ...
      if(typed.contains("pangolin"))
      {
         return getRandomFrom(pangolinInfo);
      }
      if(typed.contains("underworld"))
      {
         if(selected.getLocationType().contains("castle") || selected.getLocationType().contains("tower"))
         {
            if(CultimaPanel.player.getLocationInfo() < locationInfo.length)
            {
               String temp = locationInfo[CultimaPanel.player.nextLocationInfo()];
               ...
               return getInfoFrom(locationInfo, "underworld");
         }
         else
         {
            return getRandomFrom(underworldMageGeneral);
         }
      }
      ...
      {
         return getRandomFrom(wellsPuzzle);
      }
   ...
   public static String ironsmithResponse(NPCPlayer selected, String typed)
   {
      ...
      String[] buyCraftingManual = {"I can trade thee a Crafting Manual for 240 coins", "For 240 gold, thee can have thy Crafting Manual", "This Crafting Manual is precious. 'Twill take 240 gold to trade", "240 coins and I will trade thee my Crafting Manual"};
   ...
   public static String mageResponse(NPCPlayer selected, String typed)
   {
      ...
      String[] magicDiscount = {"For you, a 20% discount", "Any item has a 20% discount for an honoured coustomer like you", "You may have a 20% discount on any item", "Tis such an honor, a 20% discount I give to you"};
      String[] holidayDiscount = {"Tis Skara Brae Day! Tis a 50% discount on all items", "Skara Brae Day blesses us! A 50% discount today", "50% discount for all on this Skara Brae Day", "Skara Brae Day is upon us! A 50% discount for you"};
      String[] rainbowDiscount = {"The sky is cast in color! Tis a 50% discount on all items", "The magic of the rainbow blesses us! A 50% discount for a limited time", "In the brief moments of the rainbow's display, a 50% discount for all", "The rainbow is upon us! A 50% discount for you"};
      ...
      String[] eggInfo = {"A DRAGON egg is difficult to harvest, lest thee tangle with fire and death", "King GARRIOTT, King of all Cultima, is said to have the Wisdomegg", "Seek King GARRIOTT of the CAPITAL to learn the secrets of the Wisdomegg", "A DRAGON egg will supplement the might of the lucky warrior to consume it", "A Wisdomegg is not from this time, but brought here will give its owner power of the MIND"};
      String[] buyEgg = {"The coveted Wisdomegg! Take 150 gold coins in trade!", "I have 150 gold to trade for thy Wisdomegg!", "I need that Wisdomegg! Take 150 gold coins to trade!", "Take these 150 gold coins in trade for that Wisdomegg!"};
      ...
      String[] rainbowInfo = {"The arching colors lift better the magic of the mages", "The mage shoppe items may be at a discount when the rainbow colors fall across the sky", "One casting magic under the rainbow will find it takes less manna", "Thy manna will recover quite faster when the colors of the rainbow are cast overhead", "Use thy potent spells when the rainbow is above, and less energy will be spent"};
      String[] wiseMindSpell = {"Study with me: I will teach you SPELL_NAME", "Chant with me: learn the SPELL_NAME spell", "Read with me to learn a new spell - SPELL_NAME", "Focus with me: I will teach you a new spell called SPELL_NAME"};
      String[] wiseMindWeapon = {"Teach thy staff this new spell, SPELL_NAME", "Thy staff can now envoke SPELL_NAME", "Thy staff is empowered with this new spell called SPELL_NAME", "Focus with me to enchant thy staff with this new spell called SPELL_NAME"};
      String[] wiseMindPotion = {"Take this potion for your kindness", "A potion is all I can give to repay you", "Take thee this potion for your grace", "A potion is all I can offer for your great deeds"};
      String spellWord = isSpell(typed);
   ...
   public static String butcherBakerResponse(NPCPlayer selected, String typed)
   {
      ...
      String[] rationsBuy = {"Five days rations for thee...", "'Twill last a hearty traveler five moons", "Here is thy five days rations", "Thee shalt enjoy these for five moons", "A good trade...thank thee"};
   ...
   {
      String[] win = {"INCONCEIVABLE! Take thy fifty gold", "INCONCEIVABLE! You win thy fifty gold!", "This fifty gold is yours! A fair win", "Well rolled. You earn thy fifty gold"};
   ...
   public static String swine(NPCPlayer selected, String typed)
   {
      ...
      String[] honestCheater = {"The less virtuous Swine players may roll with loaded-cubes", "Beware thy grim demons that tempt you with games of chance - they cheat", "The seedy Swine players might use loaded-cubes to gain advantage on thee", "Beware - not all of my fellow Swine players can be trusted to roll a fair cube"};
   ...
   {
      String [] taxExempt = {"Thou weareth the Crown of SKARA Brae! Consider thy taxes paid!", "Thy Crown of SKARA Brae! Tis beautiful!", "To wear the Mighty Crown is to walk among her children!", "The Mighty Crown is all I need to see from thee! Thy taxes are paid!"};
  ...
  //return response for a player trying to get information on dog training
   ...
   public static String wellsPuzzleResponse(NPCPlayer selected, String typed)
   {
      ...
      String [] puzzleAsk = {"Read the BOOK, and return with a full goblet ready to SWAP!", "Thy BOOK awaits, as do we when thee is ready to SWAP a full goblet!", "Thy BOOK tells our puzzle, and we wait to SWAP a full goblet!", "See the BOOK that speak our puzzle - return with a filled goblet to SWAP!"};
      ...
      String [] cupNotFilled = {"Thy goblet is empty! Choose from the wells and return when full!", "The wells await for PLAYER_NAME to fill thy goblet!", "PLAYER_NAME - fill thy goblet before returning!", "PLAYER_NAME has an empty goblet! Fill from a well to complete the puzzle!"};
      ...
      String [] rules = {"An island rises from the water, and thee stands before us, the Puzzle Giver",
                           ...
                           "Drink from Well-One, and the poison from Well-Two or Well-Three will cure thee",
                           "Drink from Well-Two, and the poison from Well-Three is thy cure. The poison of Well-Three has no cure",
   ...
   public static String doorsPuzzleResponse(NPCPlayer selected, String typed)
   {
      ...
      String [] puzzleAsk = {"Read the BOOK, and return when ready to PICK a Door", "Thy BOOK awaits, as do I when thee is ready to PICK a Door", "Thy BOOK tells my modest Puzzle, and I wait for you to PICK a Door", "See the BOOK that speaks my Puzzle - return when ready to PICK a Door"};
      ...
      String [] pickAsk = {"Pick thy Door to open: ONE, TWO or THREE", "Will thee open Door ONE, Door TWO or Door THREE", "Pick wisely: Door ONE, TWO or THREE", "Thy Puzzle starts with the picking of a Door: ONE, TWO or THREE"};
   ...
   public static String towersPuzzleResponse(NPCPlayer selected, String typed)
   {
      ...
      String [] unknownResp = {"Thou speaketh nonsense - we are here to present a PUZZLE", "PLAYER_NAME speaks without sense - I speak in PUZZLES", "I know not what you speaketh of - you are here for a PUZZLE", "I do not know this word you speaketh. Listen to my PUZZLE"};
      String [] jobAsk = {"I present you, PLAYER_NAME, with a simple PUZZLE", "O'PLAYER_NAME, you are worthy of a modest PUZZLE", "A PUZZLE is presented to you, worthy PLAYER_NAME", "A PUZZLE is presented to thee, O'PLAYER_NAME", "Wilst thou, worthy PLAYER_NAME, take the challenge of the PUZZLE?", "This, the challenge of the PUZZLE that awaits thee, O'PLAYER_NAME"};
      String [] puzzleAsk = {"Read the BOOK, and return when ready to move the discs", "Thy BOOK awaits, as do I when thee is ready to move the Towers", "Thy BOOK tells my modest Puzzle, and I wait for you to move the disks", "See the BOOK that speaks my Puzzle - return when ready to move the Towers"};
   ...
   public static String endGameResponse(NPCPlayer selected, String typed)
   {
      ...
      String [] numberAsk = {"Does thou knowest the number, East x South?", "Sayeth the number, East x South!", "Thou must recite the number, East x South!", "Thy number to recite, sayeth East x South!"};
      String [] numberNo = {"Thou knowest the number, but PLAYER_NAME is not ready to speak it!", "Thy number is known, but thy reputation is insufficient to speak it!", "PLAYER_NAME knows the number, PLAYER_NAME is not of stature to speak it!", "Thy number is correct, O'PLAYER_NAME, but thy reputation dwildles before it!"};
   ...
   public static String slapResponse(NPCPlayer selected)
   {
      ...
      String[] slapCommonPassive = {"Outrage! This conversation has ended!", "Tis an insult! Speak to thy dust as I exit this conversation!", "How dare you raise thy hand to me! I am leaving!", "You have no right to strike me! Thee is out!", "You strike me once, never do it again!"};
