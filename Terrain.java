...
public class Terrain extends AnimatedEntity
{
   ...
   **     D_   Destroyable
   **     T_   Trap
   **     NORTH_  North moving platform
   **     EAST_   East moving platform
   **     SOUTH_  South moving platform
   **     WEST_   West moving platform
   **     $Description
   */
   ...
   public static ArrayList<Terrain> loadTerrain()
   {
      ...
      terrain.add(new Terrain(name,fileNames,neighbors,description,0,value++));
      //124
      name = "INR_L_2_$WEST_moving_platform";
      fileNames = new ArrayList<String>();
      fileNames.add("images/indoor/EWplat.jpg");
      neighbors = new HashMap<String, Integer>();
      neighbors.put("INR_$Black_floor",34);
      neighbors.put("INR_$Blue_floor",33);
      neighbors.put("INR_$Red_floor",33);
      ...
      terrain.add(new Terrain(name,fileNames,neighbors,description,0,value++));
      //125
      name = "INR_L_2_$EAST_moving_platform";
      fileNames = new ArrayList<String>();
      fileNames.add("images/indoor/EWplat.jpg");
      neighbors = new HashMap<String, Integer>();
      neighbors.put("INR_$Black_floor",34);
   ...
   {
      String terrName = this.getName().toLowerCase();
      return (terrName.contains("water") || terrName.contains("lava") || terrName.contains("bog"));
   }
   
   public boolean isMoving()
   {
      String terrName = this.getName();
      return (terrName.contains("WEST_") || terrName.contains("NORTH_") || terrName.contains("SOUTH_") || terrName.contains("EAST_"));
   } 
   ...
   public String getPlatformDirection()
   {
      ...
      {
         String terrName = this.getName();
         int index = terrName.indexOf("$");
         terrName = terrName.substring(index+1);
         index = terrName.indexOf("_");
         return terrName.substring(0,index);
      }
      return "?";
   }
}